...
/**
 * Job: Import Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.4.0.r110020
 * @status 
 */
public class Import implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Import.this, new Object[] { e,
	...
	public void tFileFetch_1_error(java.lang.Exception exception,
	...
	public void tFileFetch_1_onSubJobError(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tFileFetch_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String finalURL_tFileFetch_1 = "http://finance.yahoo.com/d/quotes.csv?s=AAPL+GOOG+MSFT";
	...
	public static void main(String[] args) {
		final Import ImportClass = new Import();

		int exitCode = ImportClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Import.class.getClassLoader()
					.getResourceAsStream(
							"stockmine/import_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Import");
		}
...
/************************************************************************************************
 * 20358 characters generated by Talend Open Studio for Data Integration on the
 * October 29, 2013 8:55:10 PM GMT
 ************************************************************************************************/
