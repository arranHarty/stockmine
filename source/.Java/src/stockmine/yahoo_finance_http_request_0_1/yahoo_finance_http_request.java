							...
							if (mapping != null) {
								...
								class Util_tLogRow_1 {
									...
									public StringBuilder format() {
										...
										sb.append("|");
										int k = 0;
										for (k = 0; k < (totals + 0 - name
												.length()) / 2; k++) {
											sb.append(' ');
										}
										sb.append(name);
										for (int i = 0; i < totals + 0
												- name.length() - k; i++) {
											sb.append(' ');
										}
										sb.append("|\n");
										...
										for (int i = 0; i < list.size(); i++) {
											...
											if (i == 0)
												sb.append(print(des_head)); // print
																			// the
																			// head
										}
								...
								util_tLogRow_1
										.addRow(new String[] { "ResponseContent", });
...
/************************************************************************************************
 * 48546 characters generated by Talend Open Studio for Data Integration on the
 * October 30, 2013 12:36:05 AM GMT
 ************************************************************************************************/
