...
public class TAccessInputBeginJava
{
  ...
  protected final String TEXT_213 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=\" + ";
  protected final String TEXT_214 = ";";
  protected final String TEXT_215 = NL + "\t            String url_";
  protected final String TEXT_216 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=\" + ";
  protected final String TEXT_217 = ";            ";
  protected final String TEXT_218 = NL + "\t\t\tjava.lang.Class.forName(\"";
  protected final String TEXT_219 = "\");" + NL + "\t\t\t";
  protected final String TEXT_220 = NL + "\t        String dbUser_";
  protected final String TEXT_221 = " = ";
  protected final String TEXT_222 = ";" + NL + "\t        String dbPwd_";
  ...
  protected final String TEXT_230 = NL + "\t\t\tString atnParams_";
  protected final String TEXT_231 = " = ";
  protected final String TEXT_232 = ";" + NL + "\t\t\tatnParams_";
  protected final String TEXT_233 = " = atnParams_";
  protected final String TEXT_234 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_235 = " = new java.util.Properties();" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_236 = ".put(\"user\",dbUser_";
  protected final String TEXT_237 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_238 = ".put(\"password\",dbPwd_";
  protected final String TEXT_239 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_240 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_241 = ".getBytes()));" + NL + "\t\t\tconn_";
  protected final String TEXT_242 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_243 = ", atnParamsPrope_";
  protected final String TEXT_244 = ");";
  protected final String TEXT_245 = NL + "            java.sql.Timestamp timestamp_";
  protected final String TEXT_246 = " = rs_";
  protected final String TEXT_247 = ".getTimestamp(column_index_";
  protected final String TEXT_248 = ");" + NL + "            if(timestamp_";
  protected final String TEXT_249 = " != null) {";
  protected final String TEXT_250 = NL + "                ";
  protected final String TEXT_251 = ".";
  protected final String TEXT_252 = " = new java.util.Date(timestamp_";
  protected final String TEXT_253 = ".getTime());" + NL + "            } else {";
  protected final String TEXT_254 = NL + "                ";
  protected final String TEXT_255 = ".";
  protected final String TEXT_256 = " =  null;" + NL + "            }";
  protected final String TEXT_257 = NL + "\t        Object value = rs_";
  protected final String TEXT_258 = ".getObject(column_index_";
  protected final String TEXT_259 = ");" + NL + "\t        if(value != null) {";
  protected final String TEXT_260 = NL + "\t   \t\t \t\t\t\tvalue = new ";
  protected final String TEXT_261 = "(";
  protected final String TEXT_262 = ".parse";
  protected final String TEXT_263 = "(value.toString()));";
  protected final String TEXT_264 = NL + "\t   \t\t \t\t\t\tvalue = new ";
  protected final String TEXT_265 = "(";
  protected final String TEXT_266 = ".parse";
  protected final String TEXT_267 = "(value.toString()));";
  protected final String TEXT_268 = NL + "\t \t   \t\t \t\t";
  protected final String TEXT_269 = ".";
  protected final String TEXT_270 = " = (";
  protected final String TEXT_271 = ")value;" + NL + "\t                } else {";
  ...
  protected final String TEXT_283 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_284 = ") {";
  protected final String TEXT_285 = NL + "\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_286 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_287 = " = dataSources_";
  protected final String TEXT_288 = ".get(";
  protected final String TEXT_289 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_290 = "\", conn_";
  protected final String TEXT_291 = ");" + NL + "\t\t        }" + NL + "\t\t\t\t";
  protected final String TEXT_292 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_293 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_294 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_295 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_296 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_297 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_303 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_304 = " + \"'.\");";
  protected final String TEXT_305 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_306 = "_QUERY\",dbquery_";
  protected final String TEXT_307 = ");" + NL + "\t\t    ";
  protected final String TEXT_308 = "\t\t    " + NL + "\t\ttry{";
  protected final String TEXT_309 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_310 = " = stmt_";
  protected final String TEXT_311 = ".executeQuery(dbquery_";
  protected final String TEXT_312 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_313 = " = rs_";
  protected final String TEXT_314 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_315 = " = rsmd_";
  protected final String TEXT_316 = ".getColumnCount();" + NL;
  protected final String TEXT_317 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_318 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_319 = ".setDbmsId(\"";
  protected final String TEXT_320 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_321 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_322 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_323 = ".add(\"";
  protected final String TEXT_324 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_325 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_326 = " = ";
  protected final String TEXT_327 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_328 = "; i <= rsmd_";
  protected final String TEXT_329 = ".getColumnCount()-";
  protected final String TEXT_330 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_331 = ".contains(rsmd_";
  protected final String TEXT_332 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_333 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_334 = ".setName(rsmd_";
  protected final String TEXT_335 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_336 = ".setDbName(rsmd_";
  protected final String TEXT_337 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_338 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_339 = "\", rsmd_";
  protected final String TEXT_340 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_341 = ".getPrecision(i), rsmd_";
  protected final String TEXT_342 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_343 = ".setDbType(rsmd_";
  protected final String TEXT_344 = ".getColumnTypeName(i));";
  protected final String TEXT_345 = NL + "                \tdcm_";
  protected final String TEXT_346 = ".setFormat(";
  protected final String TEXT_347 = ");";
  protected final String TEXT_348 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_349 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_350 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_351 = ".setLength(rsmd_";
  protected final String TEXT_352 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_353 = ".setLength(rsmd_";
  protected final String TEXT_354 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_355 = NL + "\t\t\tdcm_";
  protected final String TEXT_356 = ".setLength(rsmd_";
  protected final String TEXT_357 = ".getPrecision(i));";
  protected final String TEXT_358 = NL + "                \tdcm_";
  protected final String TEXT_359 = ".setPrecision(rsmd_";
  protected final String TEXT_360 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_361 = ".setNullable(rsmd_";
  protected final String TEXT_362 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_363 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_364 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_365 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_366 = ".metadatas.add(dcm_";
  protected final String TEXT_367 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_368 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_369 = " = null;" + NL + "\t\t    int column_index_";
  ...
  protected final String TEXT_384 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_400 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_401 = ".getObject(column_index_";
  protected final String TEXT_402 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_403 = NL + "                                    ";
  protected final String TEXT_404 = ".";
  protected final String TEXT_405 = " = new Geometry(wktValue);";
  protected final String TEXT_406 = NL + "                                        ";
  protected final String TEXT_407 = ".";
  protected final String TEXT_408 = ".setEPSG(";
  protected final String TEXT_409 = ");";
  protected final String TEXT_410 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_411 = NL + "                                  ";
  protected final String TEXT_412 = ".";
  protected final String TEXT_413 = "=dcg_";
  protected final String TEXT_414 = ";";
  protected final String TEXT_415 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_416 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_417 = " = ";
  protected final String TEXT_418 = "; i_";
  protected final String TEXT_419 = "  <= rsmd_";
  protected final String TEXT_420 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_432 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_433 = ".";
  protected final String TEXT_434 = ", rs_";
  protected final String TEXT_435 = ", fixedColumnCount_";
  protected final String TEXT_436 = ",list_";
  protected final String TEXT_437 = ");";
  protected final String TEXT_438 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_439 = ".";
  protected final String TEXT_440 = ", rs_";
  protected final String TEXT_441 = ", fixedColumnCount_";
  protected final String TEXT_442 = ");";
  protected final String TEXT_443 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_444 = ".getObject(column_index_";
  ...
  protected final String TEXT_451 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_452 = ".append(";
  protected final String TEXT_453 = ".";
  protected final String TEXT_454 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_455 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_456 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_457 = NL + "\t\t\t\t\t";
  protected final String TEXT_458 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_459 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_460 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_461 = " - Content of the record \" + nb_line_";
  protected final String TEXT_462 = " + \": \" + log4jSb_";
  protected final String TEXT_463 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_464 = ".delete(0,log4jSb_";
  protected final String TEXT_465 = ".length());" + NL + "\t\t\t\t\t";
