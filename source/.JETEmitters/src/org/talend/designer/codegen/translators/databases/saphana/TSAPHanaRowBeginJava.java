...
public class TSAPHanaRowBeginJava
{
  ...
  protected final String TEXT_6 = NL + "\tjava.lang.Class.forName(\"com.sap.db.jdbc.Driver\");" + NL + "\tString dbUser_";
  protected final String TEXT_7 = " = ";
  protected final String TEXT_8 = ";\t" + NL + "\tString dbPwd_";
  protected final String TEXT_9 = " = ";
  protected final String TEXT_10 = ";\t" + NL + "\tString dbProperties_";
  protected final String TEXT_11 = " = ";
  protected final String TEXT_12 = ";" + NL + "\tString url_";
  protected final String TEXT_13 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_14 = " + \":\" + ";
  protected final String TEXT_15 = ";" + NL + "\tif(dbProperties_";
  protected final String TEXT_16 = " != null && dbProperties_";
  protected final String TEXT_17 = ".trim().length() > 0) {" + NL + "\t\turl_";
  protected final String TEXT_18 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_19 = " + \":\" + ";
  protected final String TEXT_20 = " + \"/?\" + dbProperties_";
