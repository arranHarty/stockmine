...
public class TSybaseOutputMainJava {
  ...
  protected final String TEXT_528 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_529 = " = conn_";
  protected final String TEXT_530 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_531 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_532 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_533 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_534 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_535 = " = buffersSize_";
  protected final String TEXT_536 = ";";
  protected final String TEXT_537 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_538 = " = buffersSize_";
  ...
  protected final String TEXT_561 = NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_565 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_618 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_640 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_641 = " = pstmt_";
  protected final String TEXT_642 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_643 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_644 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_645 = " = rs_";
  protected final String TEXT_646 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_647 = " > 0) {";
  protected final String TEXT_648 = NL + "                        ";
  protected final String TEXT_649 = NL + "                            query_";
  protected final String TEXT_650 = " = ";
  protected final String TEXT_651 = ";";
  protected final String TEXT_652 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_653 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_654 = ".";
  protected final String TEXT_655 = ", pstmtUpdate_";
  ...
  protected final String TEXT_671 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_672 = " = updatedCount_";
  protected final String TEXT_673 = " + pstmtUpdate_";
  protected final String TEXT_674 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_675 = " = true;";
  protected final String TEXT_676 = NL + "                        throw(e);";
  ...
  protected final String TEXT_689 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_690 = ";";
  protected final String TEXT_691 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_709 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_727 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_728 = "++;";
  protected final String TEXT_729 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_776 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_797 = ".executeUpdate(); " + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_815 = NL + "                }" + NL + "            }" + NL + "            " + NL + "            nb_line_";
  ...
  protected final String TEXT_829 = NL + "    \t\tpstmt_";
  protected final String TEXT_830 = ".addBatch();" + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_831 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_832 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_833 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_834 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_835 = " = deletedCount_";
  protected final String TEXT_836 = " + pstmt_";
  protected final String TEXT_837 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_848 = NL + "                        rejectedCount_";
  protected final String TEXT_849 = " = rejectedCount_";
  protected final String TEXT_850 = " + 1;";
  protected final String TEXT_851 = NL + "                        ";
  protected final String TEXT_852 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_853 = ";";
  protected final String TEXT_854 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_855 = NL + "            }" + NL + "           \t";
  protected final String TEXT_856 = NL + "            nb_line_";
  protected final String TEXT_857 = "++;";
  protected final String TEXT_858 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_869 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_870 = " <= batchSizeCounter_";
  protected final String TEXT_871 = ") {                ";
  protected final String TEXT_872 = "                                                " + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_873 = " = 0;             \t                \t                \t" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_874 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_875 = ": pstmt_";
  protected final String TEXT_876 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_877 = " += (countEach_";
  protected final String TEXT_878 = " < 0 ? 0 : countEach_";
  protected final String TEXT_879 = ");" + NL + "\t\t\t\t\t\t}                \t" + NL + "            \t    \t";
  protected final String TEXT_880 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_881 = " += countSum_";
  protected final String TEXT_882 = ";" + NL + "            \t    \t";
  protected final String TEXT_883 = NL + "            \t    \t\tupdatedCount_";
  ...
  protected final String TEXT_889 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_890 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_891 = NL + "                \tint countSum_";
  protected final String TEXT_892 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_893 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_894 = " += (countEach_";
  protected final String TEXT_895 = " < 0 ? 0 : countEach_";
  protected final String TEXT_896 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_897 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_898 = " += countSum_";
  protected final String TEXT_899 = "; " + NL + "\t\t\t    \t";
  protected final String TEXT_900 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_901 = " += countSum_";
  protected final String TEXT_902 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_903 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_904 = " += countSum_";
  protected final String TEXT_905 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_906 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_907 = NL + "                }";
  protected final String TEXT_908 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  ...
  protected final String TEXT_913 = NL + "                try {" + NL + "                \t";
  protected final String TEXT_914 = NL + "\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_915 = " > 0 ) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_916 = NL + "                \t\tint countSum_";
  protected final String TEXT_917 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_918 = ": pstmt_";
  protected final String TEXT_919 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_933 = NL + "\t                \tbatchSizeCounter_";
  protected final String TEXT_934 = " = 0;  " + NL + "\t                \t";
  protected final String TEXT_935 = NL + "            \t   ";
  protected final String TEXT_936 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_937 = "          \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_938 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_939 = NL + "\t                \tint countSum_";
  protected final String TEXT_940 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_941 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_954 = " " + NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_955 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_956 = NL + "                \tconn_";
  protected final String TEXT_957 = ".commit();                " + NL + "                \tcommitCounter_";
