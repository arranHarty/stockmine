...
public class THiveLoadMainJava
{
  ...
  protected final String TEXT_238 = NL + "\t\tString path_";
  protected final String TEXT_239 = " = ";
  protected final String TEXT_240 = ";";
  protected final String TEXT_241 = NL + "\t\tString tablename_";
  protected final String TEXT_242 = " = ";
  protected final String TEXT_243 = ";";
  protected final String TEXT_244 = NL + "\t\t\tString partition_";
  protected final String TEXT_245 = " = ";
  protected final String TEXT_246 = ";";
  protected final String TEXT_247 = NL + "\t\t\tString tablename_";
  protected final String TEXT_248 = " = ";
  protected final String TEXT_249 = ";";
  protected final String TEXT_250 = NL + "\t\t\t\tString partition_";
  protected final String TEXT_251 = " = ";
  protected final String TEXT_252 = ";";
  protected final String TEXT_253 = NL + "\t\t\tString path_";
  protected final String TEXT_254 = " = ";
  protected final String TEXT_255 = ";";
  protected final String TEXT_256 = NL + "\t\tString query_";
  protected final String TEXT_257 = " = ";
  protected final String TEXT_258 = ";";
  protected final String TEXT_259 = NL + NL + "java.sql.Statement stmt_";
  protected final String TEXT_260 = " = conn_";
  protected final String TEXT_261 = ".createStatement();" + NL + "String querySQL_";
  protected final String TEXT_262 = " = \"";
  protected final String TEXT_263 = "\";" + NL + "" + NL + "try {" + NL + "\tstmt_";
  protected final String TEXT_264 = ".execute(querySQL_";
  protected final String TEXT_265 = ");" + NL + "} catch(java.sql.SQLException e_";
  protected final String TEXT_266 = ") {";
  protected final String TEXT_267 = NL + "    \tthrow(e_";
  protected final String TEXT_268 = ");";
  protected final String TEXT_269 = " " + NL + "    \tSystem.err.println(e_";
  protected final String TEXT_270 = ".getMessage());";
  protected final String TEXT_271 = NL + "}" + NL + "stmt_";
  ...
  protected final String TEXT_276 = "_QUERY\", querySQL_";
  protected final String TEXT_277 = ");" + NL + "" + NL + "String currentClientPathSeparator_";
  protected final String TEXT_278 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "if(currentClientPathSeparator_";
  protected final String TEXT_279 = "!=null) {" + NL + "\tSystem.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_280 = ");" + NL + "\tglobalMap.put(\"current_client_path_separator\", null);" + NL + "}" + NL + "" + NL + "String currentClientUsername_";
  protected final String TEXT_281 = " = (String)globalMap.get(\"current_client_user_name\");" + NL + "if(currentClientUsername_";
  protected final String TEXT_282 = "!=null) {" + NL + "\tSystem.setProperty(\"user.name\", currentClientUsername_";
  protected final String TEXT_283 = ");" + NL + "\tglobalMap.put(\"current_client_user_name\", null);" + NL + "}" + NL + "" + NL + "String originalHadoopUsername_";
