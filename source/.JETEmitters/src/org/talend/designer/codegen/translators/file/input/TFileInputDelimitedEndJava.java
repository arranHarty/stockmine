...
public class TFileInputDelimitedEndJava
{
  ...
  protected final String TEXT_15 = " - Done.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_16 = NL + "        }";
  protected final String TEXT_17 = NL + NL + "            }" + NL + "            }finally{" + NL + "                if(!((Object)(";
  protected final String TEXT_18 = ") instanceof java.io.InputStream)){" + NL + "                \tif(fid_";
  protected final String TEXT_19 = "!=null){" + NL + "                \t\tfid_";
  protected final String TEXT_20 = ".close();" + NL + "                \t}" + NL + "                }" + NL + "                if(fid_";
  protected final String TEXT_21 = "!=null){" + NL + "                \tglobalMap.put(\"";
  protected final String TEXT_22 = "_NB_LINE\", fid_";
  protected final String TEXT_23 = ".getRowNumber());" + NL + "\t\t\t\t\t";
  protected final String TEXT_24 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_25 = " - Retrieved records count: \"+ fid_";
  protected final String TEXT_26 = ".getRowNumber() + \".\");" + NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_27 = " - Done.\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_34 = NL + "\t\t\t}finally{" + NL + "    \t\t\tif(!(filename_";
  protected final String TEXT_35 = " instanceof java.io.InputStream)){" + NL + "    \t\t\t\tif(csvReader";
  protected final String TEXT_36 = "!=null){" + NL + "    \t\t\t\t\tcsvReader";
  protected final String TEXT_37 = ".close();" + NL + "    \t\t\t\t}" + NL + "    \t\t\t}" + NL + "    \t\t\tif(csvReader";
  protected final String TEXT_38 = "!=null){" + NL + "    \t\t\t\tglobalMap.put(\"";
  protected final String TEXT_39 = "_NB_LINE\",nb_line_";
  protected final String TEXT_40 = ");" + NL + "    \t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_41 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_42 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_43 = " + \".\");" + NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_44 = " - Done.\");" + NL + "\t\t\t\t";
