...
public class TSQLiteInputBeginJava
{
  ...
  protected final String TEXT_213 = " = \"jdbc:sqlite:\" + \"/\" + ";
  protected final String TEXT_214 = ";";
  protected final String TEXT_215 = NL + "\t\t\t    java.lang.Class.forName(\"";
  ...
  protected final String TEXT_236 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_237 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_238 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_239 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_240 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_248 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_249 = "_QUERY\",dbquery_";
  protected final String TEXT_250 = ");" + NL + "\t\t    ";
  protected final String TEXT_251 = "\t\t    " + NL + "\t\ttry{";
  ...
  protected final String TEXT_381 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_382 = ".";
  protected final String TEXT_383 = ", rs_";
  protected final String TEXT_384 = ", fixedColumnCount_";
  protected final String TEXT_385 = ");";
  protected final String TEXT_386 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_387 = ".getObject(column_index_";
  protected final String TEXT_388 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_389 = ".";
  protected final String TEXT_390 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_398 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_399 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_400 = NL + "\t\t\t\t\t";
  protected final String TEXT_401 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_402 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_403 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_404 = " - Content of the record \" + nb_line_";
  protected final String TEXT_405 = " + \": \" + log4jSb_";
  protected final String TEXT_406 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_407 = ".delete(0,log4jSb_";
  protected final String TEXT_408 = ".length());" + NL + "\t\t\t\t\t";
