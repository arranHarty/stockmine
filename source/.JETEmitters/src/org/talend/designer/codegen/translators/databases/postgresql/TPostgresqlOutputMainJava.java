...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_541 = NL + "                            geometryColumnName_";
  protected final String TEXT_542 = " = \"";
  protected final String TEXT_543 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_544 = ") {" + NL + "                                dimension_";
  protected final String TEXT_545 = " = 2;" + NL + "                                " + NL + "                                // A null first geometry will lead to unknown coordinate system  " + NL + "                                if (";
  protected final String TEXT_546 = ".";
  protected final String TEXT_547 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_548 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_549 = " = " + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_550 = ".";
  protected final String TEXT_551 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_552 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_553 = " = refSys_";
  protected final String TEXT_554 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_555 = " = refSys_";
  protected final String TEXT_556 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_557 = " == null || ident_";
  protected final String TEXT_558 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_559 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_560 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_561 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_562 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_563 = " = Integer.parseInt(code_";
  protected final String TEXT_564 = ");" + NL + "                                            }" + NL + "                                        } catch (java.lang.Exception e) {" + NL + "                                            System.out.println(\"SRID_";
  protected final String TEXT_565 = " could not be determined\");" + NL + "                                            SRID_";
  protected final String TEXT_566 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_567 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_568 = " = false;" + NL + "                                 }" + NL + "                            }";
  ...
  protected final String TEXT_587 = NL + "                \tsp_";
  protected final String TEXT_588 = " = conn_";
  protected final String TEXT_589 = ".setSavepoint();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_593 = ".executeUpdate();" + NL + "\t\t\t\t";
  protected final String TEXT_594 = NL + "\t                conn_";
  protected final String TEXT_595 = ".releaseSavepoint(sp_";
  protected final String TEXT_596 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_597 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_598 = NL + "\t                conn_";
  protected final String TEXT_599 = ".rollback(sp_";
  protected final String TEXT_600 = ");" + NL + "\t            ";
  protected final String TEXT_601 = NL + "                whetherReject_";
  protected final String TEXT_602 = " = true;";
  protected final String TEXT_603 = NL + "                    throw(e);";
  ...
  protected final String TEXT_624 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_625 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_645 = NL + "    \t\tpstmt_";
  protected final String TEXT_646 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_647 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_648 = NL + "    \t\t  batchSizeCounter_";
  ...
  protected final String TEXT_656 = NL + "                updatedCount_";
  protected final String TEXT_657 = " = updatedCount_";
  protected final String TEXT_658 = " + pstmt_";
  protected final String TEXT_659 = ".executeUpdate();" + NL + "\t\t\t\t";
  protected final String TEXT_660 = NL + "                \tconn_";
  protected final String TEXT_661 = ".releaseSavepoint(sp_";
  protected final String TEXT_662 = ");";
  protected final String TEXT_663 = "\t" + NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_664 = NL + "\t                conn_";
  protected final String TEXT_665 = ".rollback(sp_";
  ...
  protected final String TEXT_701 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_702 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_703 = ".";
  protected final String TEXT_704 = ", pstmtUpdate_";
  ...
  protected final String TEXT_720 = NL + "                try {" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_727 = ".executeUpdate();" + NL + "\t\t\t\t\t";
  protected final String TEXT_728 = NL + "    \t                conn_";
  protected final String TEXT_729 = ".releaseSavepoint(sp_";
  protected final String TEXT_730 = ");" + NL + "    \t            ";
  protected final String TEXT_731 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_732 = NL + "    \t                conn_";
  protected final String TEXT_733 = ".rollback(sp_";
  ...
  protected final String TEXT_758 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_759 = ".";
  protected final String TEXT_760 = ", pstmtInsert_";
  protected final String TEXT_761 = ", ";
  protected final String TEXT_762 = ", \"";
  protected final String TEXT_763 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_764 = NL + "                    globalMap.put(\"";
  protected final String TEXT_765 = "_QUERY\", query_";
  protected final String TEXT_766 = ".toString().trim());";
  protected final String TEXT_767 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_768 = NL + "\t                    sp_";
  protected final String TEXT_769 = " = conn_";
  protected final String TEXT_770 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_771 = NL + "                    insertedCount_";
  protected final String TEXT_772 = " = insertedCount_";
  protected final String TEXT_773 = " + pstmtInsert_";
  protected final String TEXT_774 = ".executeUpdate();" + NL + "\t\t\t\t\t";
  protected final String TEXT_775 = NL + "    \t                conn_";
  protected final String TEXT_776 = ".releaseSavepoint(sp_";
  protected final String TEXT_777 = ");" + NL + "    \t            ";
  protected final String TEXT_778 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_779 = NL + "    \t                conn_";
  protected final String TEXT_780 = ".rollback(sp_";
  protected final String TEXT_781 = ");" + NL + "    \t            ";
  protected final String TEXT_782 = NL + "                    whetherReject_";
  ...
  protected final String TEXT_800 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_801 = "++;";
  protected final String TEXT_802 = NL + "            int updateFlag_";
  protected final String TEXT_803 = "=0;";
  ...
  protected final String TEXT_828 = NL + "        " + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_829 = NL + "\t                sp_";
  protected final String TEXT_830 = " = conn_";
  protected final String TEXT_831 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_832 = NL + "                updateFlag_";
  protected final String TEXT_833 = "=pstmtUpdate_";
  protected final String TEXT_834 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_835 = " = updatedCount_";
  protected final String TEXT_836 = "+updateFlag_";
  protected final String TEXT_837 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_838 = NL + "\t                conn_";
  protected final String TEXT_839 = ".releaseSavepoint(sp_";
  protected final String TEXT_840 = ");" + NL + "\t            ";
  protected final String TEXT_841 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_842 = NL + "\t                conn_";
  protected final String TEXT_843 = ".rollback(sp_";
  ...
  protected final String TEXT_862 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_871 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_880 = NL + "                try {" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_887 = ".executeUpdate();" + NL + "\t\t\t\t\t";
  protected final String TEXT_888 = NL + "    \t                conn_";
  protected final String TEXT_889 = ".releaseSavepoint(sp_";
  protected final String TEXT_890 = ");" + NL + "    \t            ";
  protected final String TEXT_891 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_892 = NL + "    \t                conn_";
  protected final String TEXT_893 = ".rollback(sp_";
  ...
  protected final String TEXT_913 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_927 = NL + "    \t\tpstmt_";
  protected final String TEXT_928 = ".addBatch();" + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_929 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_930 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_931 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_932 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_933 = NL + "\t                sp_";
  protected final String TEXT_934 = " = conn_";
  protected final String TEXT_935 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_936 = NL + "                deletedCount_";
  protected final String TEXT_937 = " = deletedCount_";
  protected final String TEXT_938 = " + pstmt_";
  protected final String TEXT_939 = ".executeUpdate();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_943 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_944 = NL + "\t                conn_";
  protected final String TEXT_945 = ".rollback(sp_";
  protected final String TEXT_946 = ");" + NL + "\t            ";
  protected final String TEXT_947 = NL + "                whetherReject_";
  protected final String TEXT_948 = " = true;";
  protected final String TEXT_949 = NL + "                    throw(e);";
  ...
  protected final String TEXT_966 = NL + "            nb_line_";
  ...
  protected final String TEXT_985 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_998 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_999 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1000 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1001 = NL + "                \tint countSum_";
  ...
  protected final String TEXT_1016 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1017 = NL + "                }";
  protected final String TEXT_1018 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1019 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1020 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_1021 = " <= commitCounter_";
  protected final String TEXT_1022 = ") {" + NL + "                ";
  protected final String TEXT_1023 = NL + "                try {" + NL + "                \t\tint countSum_";
  ...
  protected final String TEXT_1056 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1057 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_1058 = NL + "                \tconn_";
  protected final String TEXT_1059 = ".commit();                " + NL + "                \tcommitCounter_";
