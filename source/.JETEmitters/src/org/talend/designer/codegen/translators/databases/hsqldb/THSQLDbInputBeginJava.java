...
public class THSQLDbInputBeginJava
{
  ...
  protected final String TEXT_215 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_216 = " + \":\" + ";
  protected final String TEXT_217 = " + \"/\" + ";
  protected final String TEXT_218 = ";";
  protected final String TEXT_219 = NL + "\t\t            url_";
  protected final String TEXT_220 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_221 = " + \":\" + ";
  protected final String TEXT_222 = " + \"/\" + ";
  protected final String TEXT_223 = ";";
  protected final String TEXT_224 = NL + "\t\t            url_";
  protected final String TEXT_225 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_226 = " + \":\" + ";
  protected final String TEXT_227 = " + \"/\" + ";
  protected final String TEXT_228 = ";";
  protected final String TEXT_229 = NL + "\t\t            url_";
  protected final String TEXT_230 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_231 = " + \":\" + ";
  protected final String TEXT_232 = " + \"/\" + ";
  protected final String TEXT_233 = ";";
  protected final String TEXT_234 = NL + "\t\t        url_";
  protected final String TEXT_235 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_236 = " + \"/\" + ";
  protected final String TEXT_237 = ";";
  protected final String TEXT_238 = NL + "\t\t\t\turl_";
  protected final String TEXT_239 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_240 = " ;";
  protected final String TEXT_241 = NL + "\t\t\t\turl_";
  protected final String TEXT_242 = " += \";\" + ";
  protected final String TEXT_243 = ";";
  protected final String TEXT_244 = NL + "    " + NL + "\t";
  protected final String TEXT_245 = NL + "\t\t    int nb_line_";
  protected final String TEXT_246 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_247 = " = null;";
  protected final String TEXT_248 = NL + "\t\t        conn_";
  protected final String TEXT_249 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_250 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_251 = ") {";
  protected final String TEXT_252 = NL + "\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_253 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_254 = " = dataSources_";
  protected final String TEXT_255 = ".get(";
  protected final String TEXT_256 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_275 = "\t\t    " + NL + "\t\ttry{";
  ...
  protected final String TEXT_299 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_311 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_336 = " = null;" + NL + "\t\t    int column_index_";
  ...
  protected final String TEXT_351 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_364 = ".getObject(column_index_";
  ...
  protected final String TEXT_410 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_411 = ".getObject(column_index_";
  ...
  protected final String TEXT_418 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  ...
  protected final String TEXT_426 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_427 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_428 = " - Content of the record \" + nb_line_";
  protected final String TEXT_429 = " + \": \" + log4jSb_";
  protected final String TEXT_430 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_431 = ".delete(0,log4jSb_";
