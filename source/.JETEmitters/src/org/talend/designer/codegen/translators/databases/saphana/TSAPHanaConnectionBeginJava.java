...
public class TSAPHanaConnectionBeginJava
{
  ...
  protected final String TEXT_22 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_23 = " + \":\" + ";
  protected final String TEXT_24 = " ;" + NL + "\t\t\tString dbProperties_";
  protected final String TEXT_25 = " = ";
  protected final String TEXT_26 = ";" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_27 = " != null && dbProperties_";
  protected final String TEXT_28 = ".trim().length() > 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_29 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_30 = " + \":\" + ";
  protected final String TEXT_31 = " + \"/?\" + dbProperties_";
  protected final String TEXT_32 = ";" + NL + "\t\t\t}";
  protected final String TEXT_33 = NL + "\t\t\tglobalMap.put(\"dbschema_\" + \"";
