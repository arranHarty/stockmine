...
public class TAmazonOracleOutputMainJava {
  ...
  protected final String TEXT_58 = " - Create table '\" + tableName_";
  protected final String TEXT_59 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_64 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_65 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_66 = " - Creating table '\" + tableName_";
  protected final String TEXT_67 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_68 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_69 = ".execute(\"";
  protected final String TEXT_70 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_77 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_88 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_89 = NL + "            stmtCreate_";
  protected final String TEXT_90 = ".close();";
  protected final String TEXT_91 = "\t         " + NL + "\t\t    " + NL + "\t\t    ";
  protected final String TEXT_92 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_93 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_94 = "+\"][\"+";
  protected final String TEXT_95 = "+\"][\"+";
  protected final String TEXT_96 = "+\"][\"+";
  protected final String TEXT_97 = "+\"][\"+";
  protected final String TEXT_98 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_99 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_100 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_101 = " = conn_";
  protected final String TEXT_102 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_103 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_104 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_105 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  ...
  protected final String TEXT_115 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_121 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_122 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_123 = " = tableNameForSearch_";
  protected final String TEXT_124 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_125 = " = tableNameForSearch_";
  protected final String TEXT_126 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_127 = " = dbMetaData_";
  protected final String TEXT_128 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_129 = ", tableNameForSearch_";
  protected final String TEXT_130 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_131 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_132 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_133 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_154 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_155 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_176 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_177 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_186 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_187 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_188 = " == null || dbschema_";
  protected final String TEXT_189 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_196 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_197 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_198 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_212 = " ==null || dbschema_";
  protected final String TEXT_213 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_214 = ".equals";
  protected final String TEXT_215 = "IgnoreCase";
  protected final String TEXT_216 = "(schema_";
  ...
  protected final String TEXT_228 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_229 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_234 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_238 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_259 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_285 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_292 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_302 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_313 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_319 = "- Clear table '\" + tableName_";
  protected final String TEXT_320 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_321 = NL + "            stmtClear_";
  protected final String TEXT_322 = ".close();";
  protected final String TEXT_323 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_324 = " = conn_";
  protected final String TEXT_325 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_326 = " = stmtTruncCount_";
  protected final String TEXT_327 = ".executeQuery(\"";
  protected final String TEXT_328 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_332 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_341 = " - Truncate table '\" + tableName_";
  protected final String TEXT_342 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_343 = NL + "            while(rsTruncCount_";
  protected final String TEXT_344 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_345 = " += rsTruncCount_";
  protected final String TEXT_346 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_347 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_348 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_349 = ".close();            ";
  protected final String TEXT_350 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_351 = " = conn_";
  protected final String TEXT_352 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_353 = " = stmtTruncCount_";
  protected final String TEXT_354 = ".executeQuery(\"";
  protected final String TEXT_355 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_359 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_368 = " - Truncate reuse stroage table '\" + tableName_";
  protected final String TEXT_369 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_370 = NL + "             while(rsTruncCount_";
  protected final String TEXT_371 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_372 = " += rsTruncCount_";
  protected final String TEXT_373 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_374 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_375 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_381 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_382 = ".";
  protected final String TEXT_383 = ",\"";
  protected final String TEXT_384 = "\")+\") VALUES (";
  protected final String TEXT_385 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_386 = ".";
  protected final String TEXT_387 = ")+\")\";";
  protected final String TEXT_388 = NL + "\t\t\t\t\t\tString insert_";
  protected final String TEXT_389 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_390 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  ...
  protected final String TEXT_419 = ");\t\t" + NL + "\t\t\t\t\t\t\t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_420 = ", pstmt_";
  protected final String TEXT_421 = ");" + NL + "\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_422 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_441 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_442 = " = new StringBuffer(update_";
  protected final String TEXT_443 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_444 = ".insert(update_";
  protected final String TEXT_445 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_446 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_447 = " =updateStringBuffer_";
  ...
  protected final String TEXT_453 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_454 = " = conn_";
  protected final String TEXT_455 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_465 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_473 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_479 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_486 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_500 = "    " + NL + "\t\t\t\tpstmtInsert_";
  ...
  protected final String TEXT_504 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_505 = " = new StringBuffer(update_";
  protected final String TEXT_506 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_507 = ".insert(update_";
  protected final String TEXT_508 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_509 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_510 = " =updateStringBuffer_";
  protected final String TEXT_511 = ".toString(); ";
  protected final String TEXT_512 = NL + "\t\t\t\tpstmtUpdate_";
  ...
  protected final String TEXT_544 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_578 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_579 = " = new StringBuffer(delete_";
  protected final String TEXT_580 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_581 = ".insert(delete_";
  protected final String TEXT_582 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_583 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_584 = " =deleteStringBuffer_";
  protected final String TEXT_585 = ".toString();  ";
  protected final String TEXT_586 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_587 = " = conn_";
  protected final String TEXT_588 = ".prepareStatement(delete_";
  protected final String TEXT_589 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_590 = NL + "\t\t\t\tStringBuffer query_";
  ...
  protected final String TEXT_596 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  ...
  protected final String TEXT_602 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_623 = " = new StringBuffer(\"\");";
  protected final String TEXT_624 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_625 = " = buffersSize_";
  protected final String TEXT_626 = ";";
  protected final String TEXT_627 = NL + "\t\t\t\tbatchSize_";
  ...
  protected final String TEXT_633 = NL + "\t\t\t\t\t     \t// TODO unable to parse integer: ";
  protected final String TEXT_634 = NL + "\t\t\t\t\t     \t// TODO error: ";
  protected final String TEXT_635 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_636 = NL + "                    \torg.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_637 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_638 = ".";
  protected final String TEXT_639 = ";" + NL + "\t                    com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_640 = " = tGeometry_";
  protected final String TEXT_641 = "._getInternalGeometry();" + NL + "                    \t" + NL + "                    \tcom.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_642 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_643 = "\");" + NL + "                    \tif (extends_";
  protected final String TEXT_644 = " == null) {" + NL + "                    \t    geometryColumnToExtends.put(\"";
  protected final String TEXT_645 = "\", geometry_";
  protected final String TEXT_646 = ".getEnvelopeInternal());" + NL + "                    \t}" + NL + "                    \telse {" + NL + "                    \t    extends_";
  protected final String TEXT_647 = ".expandToInclude(geometry_";
  protected final String TEXT_648 = ".getEnvelopeInternal()); " + NL + "                    \t}" + NL + "                    \t" + NL + "\t\t\t\t\t\tString wkt_";
  protected final String TEXT_649 = " = geometry_";
  protected final String TEXT_650 = ".toText();" + NL + "\t\t\t\t\t\toracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_651 = " = new oracle.spatial.util.WKT();" + NL + "\t\t\t\t\t\toracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_652 = " = oracle_wkt_";
  protected final String TEXT_653 = ".toJGeometry(wkt_";
  protected final String TEXT_654 = ".getBytes());" + NL;
  protected final String TEXT_655 = NL + "\t\t\t\t\t\t\tjgeometry_";
  protected final String TEXT_656 = ".setSRID(";
  protected final String TEXT_657 = ");";
  protected final String TEXT_658 = NL + "               \t\tpstmt_";
  protected final String TEXT_659 = ".setObject(";
  protected final String TEXT_660 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  ...
  protected final String TEXT_684 = "++;" + NL + "                insertedCount_";
  ...
  protected final String TEXT_702 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_703 = ";";
  protected final String TEXT_704 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_737 = NL + "             try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_741 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_765 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_766 = " = pstmt_";
  protected final String TEXT_767 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_768 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_769 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_770 = " = rs_";
  protected final String TEXT_771 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_796 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_797 = " = updatedCount_";
  protected final String TEXT_798 = " + pstmtUpdate_";
  protected final String TEXT_799 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_817 = NL + "                }" + NL + "    \t\t} else {";
  ...
  protected final String TEXT_834 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_852 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_853 = "++;" + NL + "    \t\t";
  protected final String TEXT_854 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_860 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_861 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_880 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_881 = " = pstmtUpdate_";
  protected final String TEXT_882 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_883 = " = updatedCount_";
  protected final String TEXT_884 = "+updateFlag_";
  protected final String TEXT_885 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_903 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_904 = " == 0) {" + NL + "            " + NL + "\t\t\t\t";
  protected final String TEXT_905 = NL + "\t\t\t\tquery_";
  protected final String TEXT_906 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_923 = ".executeUpdate();" + NL + "                   " + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_940 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_941 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_957 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_958 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_959 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_960 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_961 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_962 = " = deletedCount_";
  protected final String TEXT_963 = " + pstmt_";
  protected final String TEXT_964 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_979 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_980 = ";";
  protected final String TEXT_981 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_997 = " <= batchSizeCounter_";
  protected final String TEXT_998 = ") {                " + NL + "                \ttry {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_999 = ".executeBatch();" + NL + "                \t}catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1000 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1001 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1002 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_1003 = " = pstmt_";
  protected final String TEXT_1004 = ".getUpdateCount();                \t" + NL + "        \t    \t";
  protected final String TEXT_1005 = NL + "        \t    \t\tinsertedCount_";
  protected final String TEXT_1006 = NL + "        \t    \t";
  protected final String TEXT_1007 = NL + "        \t    \t\tupdatedCount_";
  protected final String TEXT_1008 = NL + "        \t    \t";
  protected final String TEXT_1009 = NL + "        \t    \t    deletedCount_";
  protected final String TEXT_1010 = NL + "        \t    \t";
  protected final String TEXT_1011 = "      " + NL + "        \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1012 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1013 = ":0);                   \t    \t" + NL + "        \t    \tbatchSizeCounter_";
  ...
  protected final String TEXT_1019 = NL + "\t\t                try {" + NL + "\t\t                \t\tpstmt_";
  protected final String TEXT_1020 = ".executeBatch();" + NL + "\t\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t\t                \t";
  protected final String TEXT_1021 = NL + "\t\t\t\t\t\t\t\tthrow(e);" + NL + "\t\t                \t";
  protected final String TEXT_1022 = NL + "\t\t                        System.out.println(e.getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_1023 = NL + "\t\t                " + NL + "\t\t                }            \t                              " + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_1024 = " = pstmt_";
  protected final String TEXT_1025 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  ...
  protected final String TEXT_1032 = "     " + NL + "\t\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1033 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1034 = ":0);" + NL + "\t                ";
  protected final String TEXT_1035 = NL + "                \tconn_";
  protected final String TEXT_1036 = ".commit();                " + NL + "                \tcommitCounter_";
  protected final String TEXT_1037 = "=0;" + NL + "                }\t";
