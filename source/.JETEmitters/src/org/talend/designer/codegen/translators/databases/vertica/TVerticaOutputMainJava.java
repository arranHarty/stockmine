...
public class TVerticaOutputMainJava {
  ...
  protected final String TEXT_413 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_414 = " <= commitCounter_";
  protected final String TEXT_415 = ") {" + NL + "                ";
  protected final String TEXT_416 = NL + "                try {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_418 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_419 = NL + "\t\t\t\t\t\tif (stmtBuilder_";
  protected final String TEXT_420 = " != null && stmtBuilder_";
  protected final String TEXT_421 = ".length() != 0 ) { // stmtBuilder_";
  protected final String TEXT_422 = " start" + NL + "\t\t\t\t\t\t\tjava.io.ByteArrayInputStream bais_";
  protected final String TEXT_423 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_424 = ".toString().getBytes());" + NL + "\t\t\t\t\t\t\t((com.vertica.PGStatement)stmt_";
  protected final String TEXT_425 = ").executeCopyIn(template_";
  protected final String TEXT_426 = ", bais_";
  protected final String TEXT_427 = ");" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_428 = " = null;" + NL + "\t\t\t\t\t\t\tif (bais_";
  protected final String TEXT_429 = " != null) {" + NL + "\t\t\t\t\t\t\t\tbais_";
  protected final String TEXT_430 = ".close();" + NL + "\t\t\t\t\t\t\t\tbais_";
  protected final String TEXT_431 = " = null;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_432 = " = new StringBuilder();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_433 = NL + NL + "            \t    \t";
  protected final String TEXT_434 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_435 = " += pstmt_";
  protected final String TEXT_436 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_437 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_438 = " += pstmt_";
  protected final String TEXT_439 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_440 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_441 = " += pstmt_";
  protected final String TEXT_442 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_443 = NL + "            \t    \t\t\tcopiedCount_";
  protected final String TEXT_444 = " += stmt_";
  protected final String TEXT_445 = ".getUpdateCount();" + NL + "            \t    \t} // stmtBuilder_";
  protected final String TEXT_446 = " end" + NL + "            \t    \t";
  protected final String TEXT_447 = "             \t    " + NL + "                }catch (java.sql.SQLException e){" + NL + "                \t";
  protected final String TEXT_448 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_449 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_450 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_451 = NL + "       \t\t\t\tconn_";
  protected final String TEXT_452 = ".commit();" + NL + "                \tcommitCounter_";
  protected final String TEXT_453 = "=0;" + NL + "                }\t";
