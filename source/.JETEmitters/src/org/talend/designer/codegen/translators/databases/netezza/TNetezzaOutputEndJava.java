...
public class TNetezzaOutputEndJava {
  ...
  protected final String TEXT_29 = NL + "\t\t\tlog.fatal(\"";
  ...
  protected final String TEXT_35 = NL + "    \tSystem.out.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_36 = "                \t" + NL + "\t}catch (java.sql.SQLException e){" + NL + "\t\t";
  protected final String TEXT_37 = NL + "\t\t\t";
  protected final String TEXT_38 = NL + "\t\t\t\tlog.fatal(\"";
  protected final String TEXT_39 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_40 = NL + "\t\t\tthrow(e);" + NL + "\t\t";
  ...
  protected final String TEXT_48 = ".close();" + NL + "            " + NL + "        }        ";
