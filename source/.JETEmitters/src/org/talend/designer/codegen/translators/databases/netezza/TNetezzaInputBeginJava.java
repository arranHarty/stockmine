...
public class TNetezzaInputBeginJava
{
  ...
  protected final String TEXT_213 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_214 = " + \":\" + ";
  protected final String TEXT_215 = " + \"/\" + ";
  protected final String TEXT_216 = ";";
  protected final String TEXT_217 = NL + "\t\t\t\tconn_";
  protected final String TEXT_218 = ".setAutoCommit(false); ";
  protected final String TEXT_219 = NL + "                stmt_";
  protected final String TEXT_220 = ".setFetchSize(";
  ...
  protected final String TEXT_227 = " = new java.util.Date(rs_";
  protected final String TEXT_228 = ".get";
  protected final String TEXT_229 = "(column_index_";
  protected final String TEXT_230 = ").getTime());" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_242 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_243 = " = dataSources_";
  protected final String TEXT_244 = ".get(";
  protected final String TEXT_245 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_266 = " = stmt_";
  protected final String TEXT_267 = ".executeQuery(dbquery_";
  protected final String TEXT_268 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_269 = " = rs_";
  protected final String TEXT_270 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_271 = " = rsmd_";
  protected final String TEXT_272 = ".getColumnCount();" + NL;
  protected final String TEXT_273 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_274 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_275 = ".setDbmsId(\"";
  protected final String TEXT_276 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_277 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_278 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_279 = ".add(\"";
  protected final String TEXT_280 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_281 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_282 = " = ";
  protected final String TEXT_283 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_284 = "; i <= rsmd_";
  protected final String TEXT_285 = ".getColumnCount()-";
  protected final String TEXT_286 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_287 = ".contains(rsmd_";
  protected final String TEXT_288 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_289 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_290 = ".setName(rsmd_";
  protected final String TEXT_291 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_292 = ".setDbName(rsmd_";
  protected final String TEXT_293 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_294 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_295 = "\", rsmd_";
  protected final String TEXT_296 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_297 = ".getPrecision(i), rsmd_";
  protected final String TEXT_298 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_299 = ".setDbType(rsmd_";
  protected final String TEXT_300 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_325 = " = null;" + NL + "\t\t    int column_index_";
  ...
  protected final String TEXT_356 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_357 = ".getObject(column_index_";
  protected final String TEXT_358 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_359 = NL + "                                    ";
  protected final String TEXT_360 = ".";
  protected final String TEXT_361 = " = new Geometry(wktValue);";
