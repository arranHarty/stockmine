...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_136 = ";" + NL + "    java.lang.Class.forName(\"com.teradata.jdbc.TeraDriver\");       " + NL + "    String dbProperties_";
  protected final String TEXT_137 = " = ";
  protected final String TEXT_138 = ";" + NL + "\tString url_";
  protected final String TEXT_139 = " = null;" + NL + "\tif(dbProperties_";
  protected final String TEXT_140 = " == null || dbProperties_";
  protected final String TEXT_141 = ".trim().length() == 0) {" + NL + "\t\turl_";
  protected final String TEXT_142 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_143 = ";     " + NL + "\t} else {" + NL + "\t    url_";
  protected final String TEXT_144 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_145 = " + \"/\" + ";
  protected final String TEXT_146 = ";" + NL + "\t}       " + NL + "    String dbUser_";
  protected final String TEXT_147 = " = ";
  protected final String TEXT_148 = ";        " + NL + "    String dbPwd_";
  protected final String TEXT_149 = " = ";
  protected final String TEXT_150 = ";        " + NL + "\t";
  protected final String TEXT_151 = "\t " + NL + "\t";
  protected final String TEXT_152 = NL + "\t\tlog.info(\"";
  protected final String TEXT_153 = " - Connection attempt to '\" + url_";
  protected final String TEXT_154 = " + \"' with the username '\" + dbUser_";
  ...
  protected final String TEXT_158 = ",dbUser_";
  protected final String TEXT_159 = ",dbPwd_";
  protected final String TEXT_160 = ");" + NL + "\t";
  protected final String TEXT_161 = NL + "\t\tlog.info(\"";
  protected final String TEXT_162 = " - Connection to '\" + url_";
  protected final String TEXT_163 = " + \"' has succeeded.\");" + NL + "\t";
  protected final String TEXT_164 = NL + "        conn_";
  protected final String TEXT_165 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_166 = " = ";
  protected final String TEXT_167 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_168 = " = 0;        ";
  protected final String TEXT_169 = NL + "if(dbname_";
  protected final String TEXT_170 = " == null || dbname_";
  protected final String TEXT_171 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_172 = " = ";
  protected final String TEXT_173 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_174 = " = dbname_";
  protected final String TEXT_175 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_176 = ";" + NL + "}";
  protected final String TEXT_177 = NL + "int count_";
  protected final String TEXT_178 = "=0;";
  protected final String TEXT_179 = "            " + NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_183 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_192 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_196 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_251 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_252 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_259 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_260 = " = conn_";
  protected final String TEXT_261 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_262 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_263 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_264 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_265 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_266 = ")== null){";
  protected final String TEXT_267 = "              ";
  protected final String TEXT_268 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_269 = " = conn_";
  protected final String TEXT_270 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_271 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_272 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_273 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_274 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_275 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_280 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_281 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_282 = " = tableNameForSearch_";
  protected final String TEXT_283 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_284 = " = tableNameForSearch_";
  protected final String TEXT_285 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_286 = " = dbMetaData_";
  protected final String TEXT_287 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_288 = ", tableNameForSearch_";
  protected final String TEXT_289 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_290 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_291 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_292 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_313 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_335 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_336 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_345 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_346 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_347 = " == null || dbschema_";
  protected final String TEXT_348 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_349 = " = conn_";
  protected final String TEXT_350 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_351 = " = stmtSchema_";
  protected final String TEXT_352 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_353 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_354 = " = rsSchema_";
  protected final String TEXT_355 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_356 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_357 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  protected final String TEXT_358 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_359 = " = rsTable_";
  protected final String TEXT_360 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_361 = " = rsTable_";
  protected final String TEXT_362 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_371 = " ==null || dbschema_";
  protected final String TEXT_372 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_373 = ".equals";
  protected final String TEXT_374 = "IgnoreCase";
  protected final String TEXT_375 = "(schema_";
  ...
  protected final String TEXT_393 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_397 = " - Creating table '\" + tableName_";
  protected final String TEXT_398 = " + \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_400 = ".execute(\"";
  protected final String TEXT_401 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_408 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_418 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_427 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_433 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_440 = " - Creating table '\" + tableName_";
  protected final String TEXT_441 = " + \"'.\" );" + NL + "\t\t\t\t\t";
  protected final String TEXT_442 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_443 = ".execute(\"";
  protected final String TEXT_444 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_451 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_461 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_468 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_472 = " - Clearing table '\" + tableName_";
  protected final String TEXT_473 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_474 = NL + "            stmtClear_";
  ...
  protected final String TEXT_478 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_482 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_483 = " = conn_";
  protected final String TEXT_484 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_485 = " = stmtTruncCount_";
  protected final String TEXT_486 = ".executeQuery(\"";
  protected final String TEXT_487 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_491 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_500 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_518 = " - Truncating reuse stroage table '\" + tableName_";
  protected final String TEXT_519 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_520 = NL + "\t\t\t";
  protected final String TEXT_521 = NL + "\t\t\tconn_";
  protected final String TEXT_522 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_523 = NL + "            stmtTrunc_";
  protected final String TEXT_524 = ".executeUpdate(\"";
  protected final String TEXT_525 = "\");" + NL + "   \t    \t";
  protected final String TEXT_526 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_527 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_554 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_582 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_583 = " = conn_";
  protected final String TEXT_584 = ".prepareStatement(insert_";
  protected final String TEXT_585 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_586 = NL + "\t    String delete_";
  protected final String TEXT_587 = " = \"DELETE FROM \\\"\" + tableName_";
