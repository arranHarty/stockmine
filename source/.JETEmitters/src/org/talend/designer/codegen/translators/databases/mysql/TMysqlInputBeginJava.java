...
public class TMysqlInputBeginJava
{
  ...
  protected final String TEXT_212 = NL + "\t\t    java.util.Calendar calendar_";
  protected final String TEXT_213 = " = java.util.Calendar.getInstance();" + NL + "\t\t    calendar_";
  protected final String TEXT_214 = ".set(0, 0, 0, 0, 0, 0);" + NL + "\t\t    java.util.Date year0_";
  protected final String TEXT_215 = " = calendar_";
  protected final String TEXT_216 = ".getTime();";
  protected final String TEXT_217 = NL + "\t\t\t\tString url_";
  protected final String TEXT_218 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_219 = " + \":\" + ";
  protected final String TEXT_220 = " + \"/\" + ";
  protected final String TEXT_221 = ";";
  protected final String TEXT_222 = NL + "\t\t\t\tString url_";
  protected final String TEXT_223 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_224 = " + \":\" + ";
  protected final String TEXT_225 = " + \"/\" + ";
  protected final String TEXT_226 = " + \"?\" + ";
  protected final String TEXT_227 = ";";
  protected final String TEXT_228 = NL + "\t\t        ((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_229 = ").enableStreamingResults();";
  protected final String TEXT_230 = NL + "\t        if(rs_";
  protected final String TEXT_231 = ".getString(column_index_";
  protected final String TEXT_232 = ") != null) {" + NL + "\t            String dateString_";
  protected final String TEXT_233 = " = rs_";
  protected final String TEXT_234 = ".getString(column_index_";
  protected final String TEXT_235 = ");" + NL + "\t            if (!(\"0000-00-00\").equals(dateString_";
  protected final String TEXT_236 = ") && !(\"0000-00-00 00:00:00\").equals(dateString_";
  ...
  protected final String TEXT_243 = " = (java.util.Date) year0_";
  protected final String TEXT_244 = ".clone();" + NL + "\t            }" + NL + "\t        } else {" + NL + "\t            ";
  ...
  protected final String TEXT_253 = "\");" + NL + "\t\t        if (null == conn_";
  ...
  protected final String TEXT_262 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_263 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_264 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_265 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_266 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_267 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_276 = "_QUERY\",dbquery_";
  protected final String TEXT_277 = ");" + NL + "\t\t    ";
  protected final String TEXT_278 = "\t\t    " + NL + "\t\ttry{";
  protected final String TEXT_279 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_280 = " = stmt_";
  protected final String TEXT_281 = ".executeQuery(dbquery_";
  protected final String TEXT_282 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_283 = " = rs_";
  protected final String TEXT_284 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_285 = " = rsmd_";
  protected final String TEXT_286 = ".getColumnCount();" + NL;
  protected final String TEXT_287 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_288 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_289 = ".setDbmsId(\"";
  protected final String TEXT_290 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_291 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_292 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_293 = ".add(\"";
  protected final String TEXT_294 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_295 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_296 = " = ";
  protected final String TEXT_297 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_298 = "; i <= rsmd_";
  protected final String TEXT_299 = ".getColumnCount()-";
  protected final String TEXT_300 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_301 = ".contains(rsmd_";
  protected final String TEXT_302 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_303 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_304 = ".setName(rsmd_";
  protected final String TEXT_305 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_306 = ".setDbName(rsmd_";
  protected final String TEXT_307 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_308 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_309 = "\", rsmd_";
  protected final String TEXT_310 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_311 = ".getPrecision(i), rsmd_";
  protected final String TEXT_312 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_313 = ".setDbType(rsmd_";
  protected final String TEXT_314 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_339 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_340 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_341 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_342 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_354 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_367 = ".getObject(column_index_";
  ...
  protected final String TEXT_372 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_373 = NL + "                                    ";
  protected final String TEXT_374 = ".";
  protected final String TEXT_375 = " = new Geometry(wktValue);";
  protected final String TEXT_376 = NL + "                                        ";
  protected final String TEXT_377 = ".";
  protected final String TEXT_378 = ".setEPSG(";
  protected final String TEXT_379 = ");";
  protected final String TEXT_380 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_381 = NL + "                                  ";
  protected final String TEXT_382 = ".";
  protected final String TEXT_383 = "=dcg_";
  protected final String TEXT_384 = ";";
  protected final String TEXT_385 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_386 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_387 = " = ";
  protected final String TEXT_388 = "; i_";
  protected final String TEXT_389 = "  <= rsmd_";
  protected final String TEXT_390 = ".getColumnCount(); i_";
  protected final String TEXT_391 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_392 = ".getColumnTypeName(i_";
  protected final String TEXT_393 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_394 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_395 = ".getClob(i_";
  protected final String TEXT_396 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_397 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_398 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_399 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_400 = ".add(tNTextImpl_";
  protected final String TEXT_401 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_402 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_414 = ".getObject(column_index_";
