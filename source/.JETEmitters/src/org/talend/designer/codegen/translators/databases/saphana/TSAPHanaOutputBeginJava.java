...
public class TSAPHanaOutputBeginJava {
  ...
  protected final String TEXT_7 = " < 1) {" + NL + "\t\t\tthrow new RuntimeException(\"For update, Schema must have a key\");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_8 = NL + "\t\tint deleteKeyCount_";
  protected final String TEXT_9 = " = ";
  protected final String TEXT_10 = ";" + NL + "\t\tif(deleteKeyCount_";
  protected final String TEXT_11 = " < 1) {" + NL + "\t\t\tthrow new RuntimeException(\"For delete, Schema must have a key\");" + NL + "\t\t}" + NL + "\t\t";
  ...
  protected final String TEXT_17 = " = 0;" + NL + "int tmp_batchUpdateCount_";
  protected final String TEXT_18 = " = 0;" + NL + "int deletedCount_";
  protected final String TEXT_19 = " = 0;" + NL + "int updatedCount_";
  protected final String TEXT_20 = " = 0;" + NL + "int insertedCount_";
  protected final String TEXT_21 = " = 0;" + NL + "int rejectedCount_";
  protected final String TEXT_22 = " = 0;" + NL + "boolean whetherReject_";
  protected final String TEXT_23 = " = false;" + NL + "String tableName_";
  ...
  protected final String TEXT_27 = "\");" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_28 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_29 = "\");";
  protected final String TEXT_30 = NL + "\tjava.lang.Class.forName(\"com.sap.db.jdbc.Driver\");" + NL + "\tString dbUser_";
  protected final String TEXT_31 = " = ";
  protected final String TEXT_32 = ";" + NL + "\tString dbPwd_";
  protected final String TEXT_33 = " = ";
  protected final String TEXT_34 = ";" + NL + "\tString dbschema_";
  protected final String TEXT_35 = "= ";
  protected final String TEXT_36 = ";\t" + NL + "\tString dbProperties_";
  protected final String TEXT_37 = " = ";
  protected final String TEXT_38 = ";" + NL + "\tString url_";
  protected final String TEXT_39 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_40 = " + \":\" + ";
  protected final String TEXT_41 = ";" + NL + "\tif(dbProperties_";
  protected final String TEXT_42 = " != null && dbProperties_";
  protected final String TEXT_43 = ".trim().length() > 0) {" + NL + "\t\turl_";
  protected final String TEXT_44 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_45 = " + \":\" + ";
  protected final String TEXT_46 = " + \"/?\" + dbProperties_";
  ...
  protected final String TEXT_62 = NL + "tableName_";
  protected final String TEXT_63 = " = ";
  protected final String TEXT_64 = ";" + NL + "if(dbschema_";
  ...
  protected final String TEXT_68 = " + \".\" + tableName_";
  ...
  protected final String TEXT_94 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_111 = " - Create table '\" + tableName_";
  protected final String TEXT_112 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_119 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_239 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_240 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_241 = " == null || dbschema_";
  protected final String TEXT_242 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_243 = " = conn_";
  protected final String TEXT_244 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_245 = " = stmtSchema_";
  protected final String TEXT_246 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_247 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_248 = " = rsSchema_";
  protected final String TEXT_249 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_250 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_251 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_260 = ") " + NL + "\t                \t&& (schema_";
  ...
  protected final String TEXT_265 = " ==null || dbschema_";
  protected final String TEXT_266 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_267 = ".equals";
  protected final String TEXT_268 = "IgnoreCase";
  protected final String TEXT_269 = "(schema_";
  ...
  protected final String TEXT_281 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_282 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_291 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_302 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_338 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_345 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_355 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_359 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_360 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  ...
  protected final String TEXT_366 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_372 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_385 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_394 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_403 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_404 = " = conn_";
  protected final String TEXT_405 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_406 = " = stmtTruncCount_";
  protected final String TEXT_407 = ".executeQuery(\"";
  protected final String TEXT_408 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_412 = " - Truncating reuse stroage table '\" + tableName_";
  protected final String TEXT_413 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_414 = NL + "\t\t\t";
  protected final String TEXT_415 = NL + "\t\t\tconn_";
  protected final String TEXT_416 = ".commit();" + NL + "\t\t\t";
  ...
  protected final String TEXT_421 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_449 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_455 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_470 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_477 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_478 = " = conn_";
  protected final String TEXT_479 = ".prepareStatement(insert_";
  protected final String TEXT_480 = ");\t\t" + NL + "\t\t";
  protected final String TEXT_481 = NL + "\t\tString delete_";
  protected final String TEXT_482 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_486 = ".prepareStatement(delete_";
  protected final String TEXT_487 = ");" + NL + "\t\t";
  protected final String TEXT_488 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_498 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_499 = " = update_";
  protected final String TEXT_500 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_501 = " = insert_";
  protected final String TEXT_502 = ".split(\"\\\\?\");";
  protected final String TEXT_503 = NL + "\t\t\tdelete_";
  protected final String TEXT_504 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_505 = " = delete_";
  protected final String TEXT_506 = ".split(\"\\\\?\");";
  protected final String TEXT_507 = NL + "\t\t\treplace_";
  protected final String TEXT_508 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_509 = " = replace_";
  protected final String TEXT_510 = ".split(\"\\\\?\");";
  protected final String TEXT_511 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_512 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_513 = " = insertIgnore_";
