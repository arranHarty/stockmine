...
public class TELTGreenplumOutputMainJava
{
  ...
  protected final String TEXT_45 = " \" +select_query.substring(select_query.indexOf(\"FROM\"));";
  protected final String TEXT_46 = NL + "\t\tif(select_query.indexOf(\"WHERE\")==-1){" + NL + "\t\tupdateQuery +=\"  WHERE \";" + NL + "\t\t}else{" + NL + "\t\tupdateQuery +=\"  AND \";" + NL + "\t\t} " + NL + "\t\tupdateQuery+= ";
  protected final String TEXT_47 = ";";
  protected final String TEXT_48 = NL + "\tpstmt_";
  protected final String TEXT_49 = " = conn_";
  protected final String TEXT_50 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_51 = NL + "\t" + NL + "\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_52 = "+\" WHERE EXISTS (\"+select_query+\") \" " + NL + "\t";
  protected final String TEXT_53 = NL + "\t+\"  AND \" + ";
  protected final String TEXT_54 = NL + "\t";
  protected final String TEXT_55 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_56 = " = conn_";
  protected final String TEXT_57 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_63 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "nb_line_inserted_";
  protected final String TEXT_64 = " = pstmt_";
  protected final String TEXT_65 = ".executeUpdate();" + NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_66 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_67 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "nb_line_update_";
  ...
  protected final String TEXT_73 = ".executeUpdate();" + NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_74 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  ...
  protected final String TEXT_79 = ".isClosed()) {" + NL + "        conn_";
  ...
  protected final String TEXT_84 = " + nb_line_deleted_";
  ...
  protected final String TEXT_92 = "_NB_LINE_DELETED\",nb_line_deleted_";
