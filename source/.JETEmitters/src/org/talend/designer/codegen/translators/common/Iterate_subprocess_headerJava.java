...
public class Iterate_subprocess_headerJava
{
  ...
  protected final String TEXT_37 = NL + "\t\t}" + NL + "" + NL + "" + NL + "\t\tpublic void run() {\t\t" + NL + "" + NL + "\t\t\tjava.util.Map threadRunResultMap = new java.util.HashMap();" + NL + "\t\t\tthreadRunResultMap.put(\"errorCode\", null);" + NL + "\t\t\tthreadRunResultMap.put(\"status\", \"\");" + NL + "\t\t\tthreadLocal.set(threadRunResultMap);" + NL + "\t\t\t" + NL + "\t\t\tthis.isRunning = true;" + NL + "\t\t\tString currentComponent = \"\";";
