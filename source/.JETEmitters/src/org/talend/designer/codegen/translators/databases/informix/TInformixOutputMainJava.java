...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_442 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_491 = ");" + NL + "\t    pstmtInsert_";
  ...
  protected final String TEXT_501 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_505 = ".prepareStatement(delete_";
  protected final String TEXT_506 = ");" + NL + "\t    ";
  protected final String TEXT_507 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_513 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_514 = " = update_";
  protected final String TEXT_515 = ".split(\"\\\\?\");";
  protected final String TEXT_516 = NL + "\t\t\tupdate_";
  protected final String TEXT_517 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_518 = " = update_";
  protected final String TEXT_519 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_520 = " = insert_";
  protected final String TEXT_521 = ".split(\"\\\\?\");";
  protected final String TEXT_522 = NL + "\t\t\tdelete_";
  protected final String TEXT_523 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_524 = " = delete_";
  protected final String TEXT_525 = ".split(\"\\\\?\");";
  protected final String TEXT_526 = NL + "\t\t\treplace_";
  protected final String TEXT_527 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_528 = " = replace_";
  protected final String TEXT_529 = ".split(\"\\\\?\");";
  protected final String TEXT_530 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_531 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_532 = " = insertIgnore_";
  ...
  protected final String TEXT_538 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_539 = " = buffersSize_";
  protected final String TEXT_540 = ";";
  protected final String TEXT_541 = NL + "\t\t\t\t\tbatchSize_";
  protected final String TEXT_542 = " = buffersSize_";
  ...
  protected final String TEXT_562 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_563 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_564 = NL + "    \t\t  \tbatchSizeCounter_";
  ...
  protected final String TEXT_619 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_620 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_621 = " = updatedCount_";
  protected final String TEXT_622 = " + pstmt_";
  protected final String TEXT_623 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_676 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_677 = " = updatedCount_";
  protected final String TEXT_678 = " + pstmtUpdate_";
  protected final String TEXT_679 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_697 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_698 = NL + "                        ";
  protected final String TEXT_699 = NL + "                            query_";
  protected final String TEXT_700 = " = ";
  protected final String TEXT_701 = ";";
  protected final String TEXT_702 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_711 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_712 = " = insertedCount_";
  protected final String TEXT_713 = " + pstmtInsert_";
  ...
  protected final String TEXT_732 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_733 = "++;";
  protected final String TEXT_734 = NL + "            int updateFlag_";
  protected final String TEXT_735 = "=0;";
  protected final String TEXT_736 = NL + "                    ";
  protected final String TEXT_737 = NL + "                        query_";
  protected final String TEXT_738 = " = ";
  protected final String TEXT_739 = ";";
  protected final String TEXT_740 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_741 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_754 = NL + "                        query_";
  protected final String TEXT_755 = " = ";
  protected final String TEXT_756 = ";";
  protected final String TEXT_757 = NL + "                globalMap.put(\"";
  protected final String TEXT_758 = "_QUERY\", query_";
  protected final String TEXT_759 = ".toString().trim());";
  protected final String TEXT_760 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_761 = "=pstmtUpdate_";
  protected final String TEXT_762 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_763 = " = updatedCount_";
  protected final String TEXT_764 = " + updateFlag_";
  protected final String TEXT_765 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_766 = " = true;";
  protected final String TEXT_767 = NL + "                    throw(e);";
  protected final String TEXT_768 = NL + "                        ";
  protected final String TEXT_769 = " = new ";
  protected final String TEXT_770 = "Struct();";
  protected final String TEXT_771 = NL + "                            ";
  protected final String TEXT_772 = ".";
  protected final String TEXT_773 = " = ";
  protected final String TEXT_774 = ".";
  protected final String TEXT_775 = ";";
  protected final String TEXT_776 = NL + "                        rejectedCount_";
  protected final String TEXT_777 = " = rejectedCount_";
  protected final String TEXT_778 = " + 1;";
  ...
  protected final String TEXT_783 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_784 = " == 0) {" + NL + "            \t";
  protected final String TEXT_785 = NL + "\t\t\t\tquery_";
  protected final String TEXT_786 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_803 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_818 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_819 = ";";
  protected final String TEXT_820 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_821 = NL + "                }" + NL + "                " + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_840 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_841 = " = deletedCount_";
  protected final String TEXT_842 = " + pstmt_";
  protected final String TEXT_843 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_854 = NL + "                        rejectedCount_";
  protected final String TEXT_855 = " = rejectedCount_";
  protected final String TEXT_856 = " + 1;";
  ...
  protected final String TEXT_864 = NL + "            if(!whetherReject_";
  protected final String TEXT_865 = ") {";
  protected final String TEXT_866 = NL + "                            ";
  protected final String TEXT_867 = " = new ";
  protected final String TEXT_868 = "Struct();";
  ...
  protected final String TEXT_875 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_876 = " <= batchSizeCounter_";
  protected final String TEXT_877 = ") {                ";
  protected final String TEXT_878 = "                                                " + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_879 = " = 0;             \t                \t                \t" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_880 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_881 = ": pstmt_";
  protected final String TEXT_882 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_883 = " += (countEach_";
  protected final String TEXT_884 = " < 0 ? 0 : countEach_";
  protected final String TEXT_885 = ");" + NL + "\t\t\t\t\t\t}" + NL + "            \t    \t";
  ...
  protected final String TEXT_892 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_893 = " += countSum_";
  protected final String TEXT_894 = ";" + NL + "            \t    \t";
  protected final String TEXT_895 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_896 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_897 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_898 = NL + "                }";
  protected final String TEXT_899 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_900 = NL + "            commitCounter_";
  protected final String TEXT_901 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_902 = "<=commitCounter_";
  protected final String TEXT_903 = ") {" + NL + "            " + NL + "                conn_";
  protected final String TEXT_904 = ".commit();" + NL + "                " + NL + "                commitCounter_";
  protected final String TEXT_905 = " = 0;" + NL + "            " + NL + "            }" + NL + "        ";
