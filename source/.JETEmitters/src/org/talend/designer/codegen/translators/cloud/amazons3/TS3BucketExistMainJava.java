...
public class TS3BucketExistMainJava
{
  ...
  protected final String TEXT_39 = NL + "boolean bucketExist_";
  protected final String TEXT_40 = "=false;" + NL + "\ttry{" + NL + "\t\tbucketExist_";
  protected final String TEXT_41 = " = conn_";
  protected final String TEXT_42 = ".doesBucketExist(";
  protected final String TEXT_43 = ");" + NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_44 = "){";
  protected final String TEXT_45 = NL + "\t\tthrow(e_";
  protected final String TEXT_46 = ");";
  protected final String TEXT_47 = NL + "\t\tSystem.err.println(e_";
  protected final String TEXT_48 = ".getMessage());";
  protected final String TEXT_49 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_50 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_51 = ".shutdown();" + NL + "\t\t}";
  protected final String TEXT_52 = NL + "\t}" + NL + "globalMap.put(\"";
  protected final String TEXT_53 = "_BUCKET_NAME\", ";
  protected final String TEXT_54 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_55 = "_BUCKET_EXIST\", bucketExist_";
