...
public class TAlfrescoOutputBeginJava
{
  ...
  protected final String TEXT_36 = ".setTimeout(5000);" + NL + "\t      // default server : localhost" + NL + "          alfrescoRestClient_";
  protected final String TEXT_37 = ".login(";
  protected final String TEXT_38 = ", ";
  protected final String TEXT_39 = ");" + NL + "      } catch (fr.openwide.talendalfresco.rest.client.RestClientException e) {" + NL + "         throw new fr.openwide.talendalfresco.rest.client.RestClientException(\"Error initing client\", e);" + NL + "      }" + NL + "      " + NL + "      int nbLine_";
  protected final String TEXT_40 = " = 0;" + NL + "        " + NL + "            ";
