...
public class TContextLoadMainJava
{
  ...
  protected final String TEXT_101 = NL + "\t\t\tlog4jSb_";
  protected final String TEXT_102 = ".append(\"Key is \\\"\" + key_";
  protected final String TEXT_103 = " + \"\\\" | Value is \\\"\" + value_";
  protected final String TEXT_104 = " + \"\\\"\");" + NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_105 = " - Loading the context \" + nb_line_";
  protected final String TEXT_106 = " + \" : \" + log4jSb_";
  protected final String TEXT_107 = " + \".\");" + NL + "\t\t\tlog4jSb_";
  protected final String TEXT_108 = ".delete(0,log4jSb_";
  protected final String TEXT_109 = ".length());" + NL + "\t\t";
