...
if ((metadatas!=null)&&(metadatas.size()>0)) {
    ...
    if (metadata != null && inMetadata != null) { 
    	...
    	Map<String, Boolean> numberTypeMap = new HashMap<String, Boolean>();
    	for(IMetadataColumn column : columns){
    		...
    		numberTypeMap.put(column.getLabel(), (JavaTypesManager.isNumberType(javaType) && javaType != JavaTypesManager.BIGDECIMAL && !column.isNullable()));
    	}
...
if(groupColumns.size() > 0){//while loop
    ...
    stringBuffer.append(TEXT_31);
		...
		if(("byte[]").equals(type) || ("Object").equals(type) || ("String").equals(type) || ("java.util.Date").equals(type) || !numberTypeMap.get(columnName)){
