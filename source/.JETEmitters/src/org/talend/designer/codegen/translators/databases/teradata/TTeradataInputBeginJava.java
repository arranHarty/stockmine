...
public class TTeradataInputBeginJava
{
  ...
  protected final String TEXT_212 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_213 = " = ";
  protected final String TEXT_214 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_215 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_216 = " == null || dbProperties_";
  protected final String TEXT_217 = ".trim().length() == 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_218 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_219 = " + \"/DATABASE=\" + ";
  protected final String TEXT_220 = ";    " + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_221 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_222 = " + \"/DATABASE=\" + ";
  protected final String TEXT_223 = " + \",\" + ";
  protected final String TEXT_224 = ";" + NL + "\t\t\t}       ";
  protected final String TEXT_225 = NL + "                stmt_";
  protected final String TEXT_226 = ".setFetchSize(200000);";
  ...
  protected final String TEXT_282 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_294 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_319 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_320 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_321 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_322 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_339 = "; \t\t\t" + NL + "\t\t                    } else {";
  ...
  protected final String TEXT_350 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_351 = ".getObject(column_index_";
  protected final String TEXT_352 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_353 = NL + "                                    ";
  protected final String TEXT_354 = ".";
  protected final String TEXT_355 = " = new Geometry(wktValue);";
  protected final String TEXT_356 = NL + "                                        ";
  protected final String TEXT_357 = ".";
  protected final String TEXT_358 = ".setEPSG(";
  ...
  protected final String TEXT_365 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_366 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_367 = " = ";
  protected final String TEXT_368 = "; i_";
  protected final String TEXT_369 = "  <= rsmd_";
  protected final String TEXT_370 = ".getColumnCount(); i_";
  protected final String TEXT_371 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_372 = ".getColumnTypeName(i_";
  protected final String TEXT_373 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_374 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_375 = ".getClob(i_";
  protected final String TEXT_376 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_377 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_378 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_379 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_380 = ".add(tNTextImpl_";
  protected final String TEXT_381 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_382 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
