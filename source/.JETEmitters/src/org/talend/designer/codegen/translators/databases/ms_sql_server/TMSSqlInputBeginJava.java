...
public class TMSSqlInputBeginJava
{
  ...
  protected final String TEXT_212 = NL + "\t\t\torg.talend.designer.components.util.mssql.MSSqlGenerateTimestampUtil mssqlGTU_";
  protected final String TEXT_213 = " = org.talend.designer.components.util.mssql.MSSqlUtilFactory.getMSSqlGenerateTimestampUtil();" + NL + "\t\t\t" + NL + "\t\t\tjava.util.List<String> talendToDBList_";
  protected final String TEXT_214 = " = new java.util.ArrayList();" + NL + "\t\t\tString[] talendToDBArray_";
  protected final String TEXT_215 = "  = new String[]{\"FLOAT\",\"NUMERIC\",\"NUMERIC IDENTITY\",\"DECIMAL\",\"DECIMAL IDENTITY\",\"REAL\"}; " + NL + "\t\t\tjava.util.Collections.addAll(talendToDBList_";
  protected final String TEXT_216 = ", talendToDBArray_";
  protected final String TEXT_217 = "); ";
  protected final String TEXT_218 = NL + "\t\t\tString dbschema_";
  protected final String TEXT_219 = " = (String)globalMap.get(\"";
  protected final String TEXT_220 = "\");";
  protected final String TEXT_221 = NL + "\t\t    String port_";
  protected final String TEXT_222 = " = ";
  protected final String TEXT_223 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_224 = " = ";
  protected final String TEXT_225 = " ;" + NL + "\t\t    String url_";
  protected final String TEXT_226 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_227 = " ; " + NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_228 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_229 = " += \":\" + ";
  protected final String TEXT_230 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_231 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_232 = " += \"//\" + ";
  protected final String TEXT_233 = "; " + NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_234 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_235 = ";" + NL + "\t\t    String dbschema_";
  protected final String TEXT_236 = " = ";
  protected final String TEXT_237 = ";";
  protected final String TEXT_238 = NL + "\t\t\t";
  protected final String TEXT_239 = ".";
  protected final String TEXT_240 = " = mssqlGTU_";
  protected final String TEXT_241 = ".getDate(rsmd_";
  protected final String TEXT_242 = ", rs_";
  protected final String TEXT_243 = ", column_index_";
  protected final String TEXT_244 = ");" + NL + "\t\t\t";
  protected final String TEXT_245 = NL + "\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_246 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_247 = ".getClob(";
  ...
  protected final String TEXT_251 = ");" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_252 = " = tNTextImpl_";
  protected final String TEXT_253 = ".getValue();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_254 = " = null;\t\t\t\t" + NL + "\t\t\t\t}";
  protected final String TEXT_255 = NL + "           \t\ttmpContent_";
  protected final String TEXT_256 = " = rs_";
  protected final String TEXT_257 = ".getString(column_index_";
  protected final String TEXT_258 = ");";
  protected final String TEXT_259 = NL + "            if(tmpContent_";
  protected final String TEXT_260 = " != null) {" + NL + "            \tif (talendToDBList_";
  protected final String TEXT_261 = " .contains(rsmd_";
  protected final String TEXT_262 = ".getColumnTypeName(column_index_";
  protected final String TEXT_263 = ").toUpperCase(java.util.Locale.ENGLISH))) {" + NL + "            \t\t";
  protected final String TEXT_264 = ".";
  protected final String TEXT_265 = " = FormatterUtils.formatUnwithE(tmpContent_";
  protected final String TEXT_266 = ");" + NL + "            \t} else {" + NL + "                \t";
  protected final String TEXT_267 = ".";
  protected final String TEXT_268 = " = tmpContent_";
  protected final String TEXT_269 = ";" + NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_279 = "\");" + NL + "\t\t        if (null == conn_";
  ...
  protected final String TEXT_288 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_289 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_290 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_291 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_292 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_293 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_294 = NL + NL + "\t\t    ";
  protected final String TEXT_295 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_296 = " = ";
  protected final String TEXT_297 = ";";
  protected final String TEXT_298 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_299 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_300 = " + \"'.\");";
  protected final String TEXT_301 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_302 = "_QUERY\",dbquery_";
  protected final String TEXT_303 = ");" + NL + "\t\t    ";
  protected final String TEXT_304 = "\t\t    " + NL + "\t\ttry{";
  ...
  protected final String TEXT_365 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_366 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_367 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_368 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_369 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_370 = NL + "\t\t    while (rs_";
  protected final String TEXT_371 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_372 = "++;" + NL + "\t\t        ";
  protected final String TEXT_373 = NL + "\t\t                        column_index_";
  ...
  protected final String TEXT_380 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_392 = " = (List)rs_";
  protected final String TEXT_393 = ".getObject(column_index_";
  protected final String TEXT_394 = ");";
  protected final String TEXT_395 = NL + "\t\t                         ";
  protected final String TEXT_396 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_397 = ".getObject(column_index_";
  protected final String TEXT_398 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_399 = NL + "                                    ";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_411 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_412 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_428 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_429 = ".";
  protected final String TEXT_430 = ", rs_";
  protected final String TEXT_431 = ", fixedColumnCount_";
  protected final String TEXT_432 = ",list_";
  protected final String TEXT_433 = ");";
  protected final String TEXT_434 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_435 = ".";
  protected final String TEXT_436 = ", rs_";
  protected final String TEXT_437 = ", fixedColumnCount_";
  protected final String TEXT_438 = ");";
  protected final String TEXT_439 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_440 = ".getObject(column_index_";
  protected final String TEXT_441 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_442 = ".";
  protected final String TEXT_443 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_454 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_455 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_456 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_457 = " - Content of the record \" + nb_line_";
  protected final String TEXT_458 = " + \": \" + log4jSb_";
  protected final String TEXT_459 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_460 = ".delete(0,log4jSb_";
  protected final String TEXT_461 = ".length());" + NL + "\t\t\t\t\t";
  protected final String TEXT_462 = NL + "\t\t                            ";
  protected final String TEXT_463 = ".";
  protected final String TEXT_464 = " = ";
  protected final String TEXT_465 = ".";
  protected final String TEXT_466 = ";" + NL + "\t\t                            ";
  protected final String TEXT_467 = NL + NL + NL + NL + NL;
