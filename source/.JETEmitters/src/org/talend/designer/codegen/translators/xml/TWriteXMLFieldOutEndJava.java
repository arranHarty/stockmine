...
public class TWriteXMLFieldOutEndJava {
  ...
  protected final String TEXT_185 = "_FINISH\", \"true\");" + NL + "\t";
  protected final String TEXT_186 = NL + "\t\ttxf_";
  protected final String TEXT_187 = ".join();" + NL + "\t\tif(txf_";
  protected final String TEXT_188 = ".getLastException()!=null) {" + NL + "\t\t\tcurrentComponent = txf_";
  protected final String TEXT_189 = ".getCurrentComponent();" + NL + "\t\t\tthrow txf_";
  protected final String TEXT_190 = ".getLastException();" + NL + "\t\t}" + NL + "\t";
