...
public class TAlfrescoOutputEndJava
{
  ...
  protected final String TEXT_30 = ");" + NL + "      " + NL + "      " + NL + "      // handling result logs" + NL + "      System.out.println(importCmd_";
  protected final String TEXT_31 = ".toString() + \" \" + importCmd_";
  protected final String TEXT_32 = ".getResultMessage() + \" \" + importCmd_";
  protected final String TEXT_33 = ".getResultError());" + NL + "      " + NL + "    java.io.File resultLogFile_";
  protected final String TEXT_34 = " = new java.io.File(";
  protected final String TEXT_35 = ");" + NL + "    java.io.BufferedWriter resultLogOut_";
  protected final String TEXT_36 = " = new java.io.BufferedWriter(" + NL + "            new java.io.OutputStreamWriter(new java.io.FileOutputStream(resultLogFile_";
  protected final String TEXT_37 = ")));" + NL + "      for (String[] resultLog_";
  protected final String TEXT_38 = " : importCmd_";
  protected final String TEXT_39 = ".getResultLogs()) {" + NL + "         String successOrError_";
  protected final String TEXT_40 = " = resultLog_";
  protected final String TEXT_41 = "[0];" + NL + "         resultLogOut_";
  protected final String TEXT_42 = ".write(successOrError_";
  protected final String TEXT_43 = "); // success or error" + NL + "         resultLogOut_";
  protected final String TEXT_44 = ".write(\";\");" + NL + "         resultLogOut_";
  protected final String TEXT_45 = ".write(resultLog_";
  protected final String TEXT_46 = "[1]); // namepath" + NL + "         resultLogOut_";
  protected final String TEXT_47 = ".write(\";\");" + NL + "         String message_";
  protected final String TEXT_48 = " = resultLog_";
  protected final String TEXT_49 = "[2];" + NL + "         if (message_";
  protected final String TEXT_50 = " != null) {" + NL + "         \tif (!\"success\".equals(successOrError_";
  protected final String TEXT_51 = ")) {" + NL + "         \t\tmessage_";
  protected final String TEXT_52 = " = message_";
  protected final String TEXT_53 = ".replaceAll(\";\", \",\").replaceAll(\"\\n\", \"   \");" + NL + "         \t}" + NL + "         \tresultLogOut_";
  protected final String TEXT_54 = ".write(message_";
  protected final String TEXT_55 = "); // message" + NL + "         \tresultLogOut_";
  protected final String TEXT_56 = ".write(\";\");" + NL + "         }" + NL + "         resultLogOut_";
  protected final String TEXT_57 = ".write(resultLog_";
  protected final String TEXT_58 = "[3]); // date" + NL + "         resultLogOut_";
  protected final String TEXT_59 = ".write(\";\");" + NL + "         if (resultLog_";
  protected final String TEXT_60 = "[4] != null) {" + NL + "         \tresultLogOut_";
  protected final String TEXT_61 = ".write(resultLog_";
  protected final String TEXT_62 = "[4]); // noderef" + NL + "         \tresultLogOut_";
  protected final String TEXT_63 = ".write(\";\");" + NL + "         }" + NL + "         if (resultLog_";
  protected final String TEXT_64 = "[5] != null) {" + NL + "         \tresultLogOut_";
  protected final String TEXT_65 = ".write(resultLog_";
  protected final String TEXT_66 = "[5]); // doctype" + NL + "         }" + NL + "         resultLogOut_";
  protected final String TEXT_67 = ".write(\"\\n\");" + NL + "      }" + NL + "    resultLogOut_";
  protected final String TEXT_68 = ".close();" + NL + "    " + NL + "    System.out.println(\"Result (log file \" + ";
  protected final String TEXT_69 = " + \") :\\n\");" + NL + "    java.io.BufferedReader resultLogIn_";
  protected final String TEXT_70 = " = new java.io.BufferedReader(" + NL + "            new java.io.InputStreamReader(new java.io.FileInputStream(resultLogFile_";
  protected final String TEXT_71 = ")));" + NL + "    String resultLogInLine_";
  protected final String TEXT_72 = ";" + NL + "    while  ((resultLogInLine_";
  protected final String TEXT_73 = " = resultLogIn_";
  protected final String TEXT_74 = ".readLine()) != null) {" + NL + "    \tSystem.out.println(resultLogInLine_";
  protected final String TEXT_75 = ");" + NL + "    }" + NL + "    resultLogIn_";
