...
public class TDBInputBeginJava
{
  ...
  protected final String TEXT_213 = " = \"jdbc:odbc:\"+";
  protected final String TEXT_214 = ";";
  protected final String TEXT_215 = NL + "\t\t        String url_";
  protected final String TEXT_216 = " = \"jdbc:odbc:\"+";
  ...
  protected final String TEXT_224 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_225 = "+\":\"+";
  protected final String TEXT_226 = "+\"/\"+";
  protected final String TEXT_227 = ";";
  protected final String TEXT_228 = NL + "\t\t        String url_";
  protected final String TEXT_229 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_230 = " + \":\" + ";
  protected final String TEXT_231 = " + \"/\" + ";
  protected final String TEXT_232 = ";";
  protected final String TEXT_233 = NL + "\t\t\tjava.lang.Class.forName(\"";
  protected final String TEXT_234 = "\");" + NL + "\t\t\t";
  protected final String TEXT_235 = NL + "\t        String userName_";
  protected final String TEXT_236 = " = ";
  protected final String TEXT_237 = ";" + NL + "\t        String password_";
  protected final String TEXT_238 = " = ";
  protected final String TEXT_239 = ";" + NL + "\t\t\tString dbProperties_";
  protected final String TEXT_240 = " = ";
  protected final String TEXT_241 = ";" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_242 = " == null || dbProperties_";
  protected final String TEXT_243 = ".trim().length() == 0) {" + NL + "\t\t\t\tconn_";
  protected final String TEXT_244 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_245 = ",userName_";
  protected final String TEXT_246 = ",password_";
  protected final String TEXT_247 = ");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tdbProperties_";
  protected final String TEXT_248 = " = dbProperties_";
  protected final String TEXT_249 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_250 = " = new java.util.Properties();" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_251 = ".put(\"user\",userName_";
  protected final String TEXT_252 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_253 = ".put(\"password\",password_";
  protected final String TEXT_254 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_255 = ".load(new java.io.ByteArrayInputStream(dbProperties_";
  protected final String TEXT_256 = ".getBytes()));" + NL + "\t\t\t\tconn_";
  protected final String TEXT_257 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_258 = ", atnParamsPrope_";
  protected final String TEXT_259 = ");" + NL + "\t\t\t}";
  protected final String TEXT_260 = NL + "            java.sql.Timestamp timestamp_";
  protected final String TEXT_261 = " = rs_";
  protected final String TEXT_262 = ".getTimestamp(column_index_";
  protected final String TEXT_263 = ");" + NL + "            if(timestamp_";
  protected final String TEXT_264 = " != null) {";
  protected final String TEXT_265 = NL + "                ";
  protected final String TEXT_266 = ".";
  protected final String TEXT_267 = " = new java.util.Date(timestamp_";
  protected final String TEXT_268 = ".getTime());" + NL + "            } else {";
  protected final String TEXT_269 = NL + "                ";
  protected final String TEXT_270 = ".";
  protected final String TEXT_271 = " =  null;" + NL + "            }";
  protected final String TEXT_272 = NL + "\t\t\tObject value_";
  protected final String TEXT_273 = " = rs_";
  protected final String TEXT_274 = ".get";
  protected final String TEXT_275 = "(column_index_";
  protected final String TEXT_276 = ");" + NL + "\t\t\tif(value_";
  protected final String TEXT_277 = " != null) {";
  protected final String TEXT_278 = NL + "\t\t\t\t\tvalue_";
  protected final String TEXT_279 = " = new ";
  protected final String TEXT_280 = "(";
  protected final String TEXT_281 = ".parse";
  protected final String TEXT_282 = "(value_";
  protected final String TEXT_283 = ".toString()));";
  protected final String TEXT_284 = NL + "\t\t\t\t\tvalue_";
  protected final String TEXT_285 = " = new ";
  protected final String TEXT_286 = "(";
  protected final String TEXT_287 = ".parse";
  protected final String TEXT_288 = "(value_";
  protected final String TEXT_289 = ".toString()));";
  protected final String TEXT_290 = NL + "\t\t\t\t";
  protected final String TEXT_291 = ".";
  protected final String TEXT_292 = " = (";
  protected final String TEXT_293 = ")value_";
  ...
  protected final String TEXT_300 = NL + "\t\t\ttry {" + NL + "            \ttmpContent_";
  protected final String TEXT_301 = " = rs_";
  protected final String TEXT_302 = ".getString(column_index_";
  protected final String TEXT_303 = ");" + NL + "\t\t\t} catch (java.sql.SQLException e) {" + NL + "\t\t\t\tif (\"No data found\".equals(e.getMessage())) {" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_304 = " = \"\";" + NL + "\t\t\t\t}else {" + NL + "\t\t\t\t\tthrow e;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "            if(tmpContent_";
  protected final String TEXT_305 = " != null) {";
  protected final String TEXT_306 = NL + "                ";
  protected final String TEXT_307 = ".";
  protected final String TEXT_308 = " = tmpContent_";
  ...
  protected final String TEXT_314 = NL + "\t\t    int nb_line_";
  protected final String TEXT_315 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_316 = " = null;";
  protected final String TEXT_317 = NL + "\t\t        conn_";
  protected final String TEXT_318 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_319 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_320 = ") {";
  protected final String TEXT_321 = NL + "\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_322 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_323 = " = dataSources_";
  protected final String TEXT_324 = ".get(";
  protected final String TEXT_325 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_326 = "\", conn_";
  protected final String TEXT_327 = ");" + NL + "\t\t        }" + NL + "\t\t\t\t";
  protected final String TEXT_328 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_329 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_330 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_331 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_332 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_333 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_334 = NL + NL + "\t\t    ";
  protected final String TEXT_335 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_336 = " = ";
  protected final String TEXT_337 = ";";
  protected final String TEXT_338 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_339 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_340 = " + \"'.\");";
  protected final String TEXT_341 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_342 = "_QUERY\",dbquery_";
  protected final String TEXT_343 = ");" + NL + "\t\t    ";
  protected final String TEXT_344 = "\t\t    " + NL + "\t\ttry{";
  ...
  protected final String TEXT_368 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_369 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_370 = ".setName(rsmd_";
  protected final String TEXT_371 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_380 = ".getColumnTypeName(i));";
  protected final String TEXT_381 = NL + "                \tdcm_";
  protected final String TEXT_382 = ".setFormat(";
  protected final String TEXT_383 = ");";
  protected final String TEXT_384 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_385 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_386 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_387 = ".setLength(rsmd_";
  protected final String TEXT_388 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_389 = ".setLength(rsmd_";
  protected final String TEXT_390 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_391 = NL + "\t\t\tdcm_";
  protected final String TEXT_392 = ".setLength(rsmd_";
  protected final String TEXT_393 = ".getPrecision(i));";
  protected final String TEXT_394 = NL + "                \tdcm_";
  protected final String TEXT_395 = ".setPrecision(rsmd_";
  protected final String TEXT_396 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_397 = ".setNullable(rsmd_";
  protected final String TEXT_398 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_399 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_400 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_401 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_402 = ".metadatas.add(dcm_";
  protected final String TEXT_403 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_404 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_405 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_406 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_407 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_408 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_409 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_410 = NL + "\t\t    while (rs_";
  protected final String TEXT_411 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_412 = "++;" + NL + "\t\t        ";
  protected final String TEXT_413 = NL + "\t\t                        column_index_";
  protected final String TEXT_414 = " = ";
  protected final String TEXT_415 = " + dcg_";
  protected final String TEXT_416 = ".getColumnCount(); " + NL + "\t\t                    ";
  protected final String TEXT_417 = NL + "\t\t                        column_index_";
  protected final String TEXT_418 = " = ";
  protected final String TEXT_419 = ";" + NL + "\t\t                    ";
  protected final String TEXT_420 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_432 = " = (List)rs_";
  protected final String TEXT_433 = ".getObject(column_index_";
  protected final String TEXT_434 = ");";
  protected final String TEXT_435 = NL + "\t\t                         ";
  protected final String TEXT_436 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_437 = ".getObject(column_index_";
  protected final String TEXT_438 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_439 = NL + "                                    ";
  protected final String TEXT_440 = ".";
  protected final String TEXT_441 = " = new Geometry(wktValue);";
  protected final String TEXT_442 = NL + "                                        ";
  protected final String TEXT_443 = ".";
  protected final String TEXT_444 = ".setEPSG(";
  protected final String TEXT_445 = ");";
  protected final String TEXT_446 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_447 = NL + "                                  ";
  protected final String TEXT_448 = ".";
  protected final String TEXT_449 = "=dcg_";
  protected final String TEXT_450 = ";";
  protected final String TEXT_451 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_452 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_453 = " = ";
  protected final String TEXT_454 = "; i_";
  protected final String TEXT_455 = "  <= rsmd_";
  protected final String TEXT_456 = ".getColumnCount(); i_";
  protected final String TEXT_457 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_458 = ".getColumnTypeName(i_";
  protected final String TEXT_459 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_460 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_461 = ".getClob(i_";
  protected final String TEXT_462 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_463 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_464 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_465 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_466 = ".add(tNTextImpl_";
  protected final String TEXT_467 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_468 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_469 = ".";
  protected final String TEXT_470 = ", rs_";
  protected final String TEXT_471 = ", fixedColumnCount_";
  protected final String TEXT_472 = ",list_";
  ...
  protected final String TEXT_480 = ".getObject(column_index_";
  protected final String TEXT_481 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_482 = ".";
  protected final String TEXT_483 = " = new Geometry(sb.toString());";
