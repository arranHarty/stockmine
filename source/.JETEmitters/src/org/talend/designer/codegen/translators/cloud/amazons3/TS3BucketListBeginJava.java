...
public class TS3BucketListBeginJava
{
  ...
  protected final String TEXT_39 = NL + "int nb_bucket_";
  protected final String TEXT_40 = " = 0;" + NL + "java.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_41 = " = conn_";
  protected final String TEXT_42 = ".listBuckets();";
  protected final String TEXT_43 = NL + "try{";
  protected final String TEXT_44 = NL + "\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_45 = " : buckets_";
  protected final String TEXT_46 = ") {" + NL + "\t\tnb_bucket_";
  protected final String TEXT_47 = "++;" + NL + "\t\tString currentBucketName_";
  protected final String TEXT_48 = " = bucket_";
  protected final String TEXT_49 = ".getName();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_50 = "_CURRENT_BUCKET_NAME\", currentBucketName_";
