...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_131 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_241 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_242 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_243 = ")))) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_251 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_252 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_253 = " == null || dbschema_";
  protected final String TEXT_254 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_255 = " = conn_";
  protected final String TEXT_256 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_257 = " = stmtSchema_";
  protected final String TEXT_258 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_259 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_260 = " = rsSchema_";
  protected final String TEXT_261 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_262 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_263 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_277 = " ==null || dbschema_";
  protected final String TEXT_278 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_279 = ".equals";
  protected final String TEXT_280 = "IgnoreCase";
  protected final String TEXT_281 = "(schema_";
  ...
  protected final String TEXT_314 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_328 = NL + "                if(whetherExist_";
  protected final String TEXT_329 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_333 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_339 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_346 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_357 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_453 = " = null;    " + NL + "\t\tString keyPsmt_";
  protected final String TEXT_454 = " = conn_";
  protected final String TEXT_455 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_456 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_457 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_458 = ",insert_";
  protected final String TEXT_459 = ",keyPsmt_";
  ...
  protected final String TEXT_471 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_492 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_504 = " = \"DELETE FROM [\" + tableName_";
  ...
  protected final String TEXT_512 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_518 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_519 = " = conn_";
  protected final String TEXT_520 = ".prepareStatement(insert_";
  protected final String TEXT_521 = ");";
  protected final String TEXT_522 = NL + "    \t" + NL + "    class BufferLine_";
  protected final String TEXT_523 = " {";
  protected final String TEXT_524 = NL + "                ";
  protected final String TEXT_525 = " ";
  protected final String TEXT_526 = ";                ";
  protected final String TEXT_527 = "   " + NL + "    " + NL + "        public BufferLine_";
  ...
  protected final String TEXT_536 = "   \t                " + NL + "        }" + NL + "    }" + NL + "    " + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_537 = "> sInsertColValueList";
  protected final String TEXT_538 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_539 = " sInsertColValue";
  protected final String TEXT_540 = " = null; " + NL + "    " + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_541 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_542 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_543 = ".append(\"(";
  protected final String TEXT_544 = ")\");" + NL + "         if (i!=";
  ...
  protected final String TEXT_550 = ".toString();" + NL + "\t" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_551 = " =  conn_";
  protected final String TEXT_552 = ".prepareStatement(insert_";
  protected final String TEXT_553 = ");" + NL + "      " + NL + "    String insertColName";
  protected final String TEXT_554 = " = \"";
  protected final String TEXT_555 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_556 = " =  \"";
  protected final String TEXT_557 = "\"; " + NL + "    int rowCount";
  ...
  protected final String TEXT_564 = NL + "\t\t\tupdate_";
  protected final String TEXT_565 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_566 = " = update_";
  ...
  protected final String TEXT_571 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_576 = " = delete_";
  protected final String TEXT_577 = ".split(\"\\\\?\");";
  protected final String TEXT_578 = NL + "\t\t\treplace_";
  protected final String TEXT_579 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_580 = " = replace_";
  protected final String TEXT_581 = ".split(\"\\\\?\");";
  protected final String TEXT_582 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_583 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_584 = " = insertIgnore_";
  protected final String TEXT_585 = ".split(\"\\\\?\");";
  protected final String TEXT_586 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_587 = " = insert_";
  protected final String TEXT_588 = ".split(\"\\\\?\");";
  protected final String TEXT_589 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_590 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_591 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_592 = "\") == true;";
  protected final String TEXT_593 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_594 = " = conn_";
  protected final String TEXT_595 = ".createStatement();";
  protected final String TEXT_596 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_597 = " ) {" + NL + "\t        \tstmt_";
  protected final String TEXT_598 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_599 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_600 = NL + "     \t\tstmt_";
  protected final String TEXT_601 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_602 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_603 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_604 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_605 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
