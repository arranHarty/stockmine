...
public class TIngresInputBeginJava
{
  ...
  protected final String TEXT_213 = " = \"jdbc:ingres://\" + ";
  ...
  protected final String TEXT_233 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_234 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_235 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_236 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_237 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_248 = "\t\t    " + NL + "\t\ttry{";
  ...
  protected final String TEXT_383 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_384 = ".getObject(column_index_";
  protected final String TEXT_385 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_386 = ".";
  protected final String TEXT_387 = " = new Geometry(sb.toString());";
  protected final String TEXT_388 = NL + "\t\t                          ";
  protected final String TEXT_389 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_390 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_391 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  ...
  protected final String TEXT_399 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_400 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_401 = " - Content of the record \" + nb_line_";
  protected final String TEXT_402 = " + \": \" + log4jSb_";
  protected final String TEXT_403 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_404 = ".delete(0,log4jSb_";
  protected final String TEXT_405 = ".length());" + NL + "\t\t\t\t\t";
  protected final String TEXT_406 = NL + "\t\t                            ";
  protected final String TEXT_407 = ".";
  protected final String TEXT_408 = " = ";
  protected final String TEXT_409 = ".";
  protected final String TEXT_410 = ";" + NL + "\t\t                            ";
  protected final String TEXT_411 = NL + NL + NL;
