...
public class THDFSDeleteMainJava
{
  ...
  protected final String TEXT_63 = ");" + NL + "\tif(fs_";
  protected final String TEXT_64 = ".exists(path_";
  protected final String TEXT_65 = ")){" + NL + "\t\tif(fs_";
  protected final String TEXT_66 = ".delete(path_";
  protected final String TEXT_67 = ", true)){" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_68 = "_CURRENT_STATUS\", \"Path deleted.\");" + NL + "\t\t}else{" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_69 = "_CURRENT_STATUS\", \"No path deleted.\");" + NL + "\t\t}" + NL + "\t}else{" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_70 = "_CURRENT_STATUS\", \"Path does not exists.\");" + NL + "\t}" + NL + "\tglobalMap.put(\"";
