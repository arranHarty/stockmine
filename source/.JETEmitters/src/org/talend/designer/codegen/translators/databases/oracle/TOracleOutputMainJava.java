...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_44 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_51 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_67 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_68 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_69 = " - Creating table '\" + tableName_";
  protected final String TEXT_70 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_71 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_72 = ".execute(\"";
  protected final String TEXT_73 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_90 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_179 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_180 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_216 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_217 = ".equals";
  protected final String TEXT_218 = "IgnoreCase";
  protected final String TEXT_219 = "(schema_";
  ...
  protected final String TEXT_241 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_271 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_277 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_284 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_305 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_309 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_310 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_311 = "            ";
  protected final String TEXT_312 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_316 = " - Clearing table '\" + tableName_";
  protected final String TEXT_317 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_318 = NL + "            stmtClear_";
  protected final String TEXT_319 = ".executeUpdate(\"";
  protected final String TEXT_320 = "\");" + NL + "   \t    \t";
  protected final String TEXT_321 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_322 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_335 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_344 = " - Truncate table '\" + tableName_";
  protected final String TEXT_345 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_346 = NL + "            while(rsTruncCount_";
  protected final String TEXT_347 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_348 = " += rsTruncCount_";
  protected final String TEXT_349 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_350 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_351 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_362 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_371 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_400 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_401 = " = new StringBuffer(insert_";
  protected final String TEXT_402 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_403 = ".insert(insert_";
  protected final String TEXT_404 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_405 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_406 = " =insertStringBuffer_";
  ...
  protected final String TEXT_415 = " = null;         " + NL + "\t\t\t\t\t\t\t\t// [%connection%][psmt][tableName]" + NL + "\t\t\t\t\t\t\t\tString keyPsmt_";
  protected final String TEXT_416 = " = conn_";
  protected final String TEXT_417 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_418 = " + \"]\";" + NL + "\t\t\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_419 = ")== null){" + NL + "\t\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_420 = " = conn_";
  protected final String TEXT_421 = ".prepareStatement(insert_";
  protected final String TEXT_422 = ");\t\t" + NL + "\t\t\t\t\t\t\t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_423 = ", pstmt_";
  protected final String TEXT_424 = ");" + NL + "\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_425 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_431 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_432 = ".";
  protected final String TEXT_433 = ", \"";
  protected final String TEXT_434 = "\")+\" WHERE ";
  protected final String TEXT_435 = "\";";
  protected final String TEXT_436 = NL + "\t\t\t\t\t\tString update_";
  protected final String TEXT_437 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_438 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_439 = ".";
  protected final String TEXT_440 = ", \"";
  protected final String TEXT_441 = "\")+\" WHERE ";
  protected final String TEXT_442 = "\";";
  protected final String TEXT_443 = NL + "\t\t\t\t";
  protected final String TEXT_444 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_445 = " = new StringBuffer(update_";
  protected final String TEXT_446 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_447 = ".insert(update_";
  protected final String TEXT_448 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_449 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_450 = " =updateStringBuffer_";
  protected final String TEXT_451 = ".toString(); ";
  protected final String TEXT_452 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_453 = " = conn_";
  protected final String TEXT_454 = ".prepareStatement(update_";
  protected final String TEXT_455 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_456 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_457 = " = conn_";
  protected final String TEXT_458 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_482 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_489 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_503 = "    " + NL + "\t\t\t\tpstmtInsert_";
  ...
  protected final String TEXT_507 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_508 = " = new StringBuffer(update_";
  protected final String TEXT_509 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_510 = ".insert(update_";
  protected final String TEXT_511 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_512 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_513 = " =updateStringBuffer_";
  protected final String TEXT_514 = ".toString(); ";
  protected final String TEXT_515 = NL + "\t\t\t\tpstmtUpdate_";
  ...
  protected final String TEXT_581 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_582 = " = new StringBuffer(delete_";
  protected final String TEXT_583 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_584 = ".insert(delete_";
  protected final String TEXT_585 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_586 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_587 = " =deleteStringBuffer_";
  protected final String TEXT_588 = ".toString();  ";
  protected final String TEXT_589 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_590 = " = conn_";
  protected final String TEXT_591 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_681 = NL + "\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_682 = " = \"Inserting\";" + NL + "\t\t\t";
  ...
  protected final String TEXT_687 = NL + "\t\t\t\t\tdataOperationSuffix_";
  protected final String TEXT_688 = " = \" to the ";
  protected final String TEXT_689 = " batch\";" + NL + "\t\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_690 = " = \"Adding\";" + NL + "\t\t\t\t";
  protected final String TEXT_691 = NL + "\t\t\t\tbatchSizeCounter_";
  protected final String TEXT_692 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_693 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_694 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_695 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_696 = NL + "\t\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_697 = " = \"Inserting\";" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_701 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_702 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_703 = " = true;";
  protected final String TEXT_704 = NL + "                \t";
  protected final String TEXT_705 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_706 = " - \" + e_";
  protected final String TEXT_707 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_708 = NL + "                    throw(e_";
  protected final String TEXT_709 = ");";
  protected final String TEXT_710 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_711 = " - \" + e_";
  protected final String TEXT_712 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_713 = NL + "                        ";
  protected final String TEXT_714 = " = new ";
  protected final String TEXT_715 = "Struct();";
  protected final String TEXT_716 = NL + "                            ";
  protected final String TEXT_717 = ".";
  protected final String TEXT_718 = " = ";
  protected final String TEXT_719 = ".";
  protected final String TEXT_720 = ";";
  protected final String TEXT_721 = NL + "                        rejectedCount_";
  protected final String TEXT_722 = " = rejectedCount_";
  protected final String TEXT_723 = " + 1;";
  protected final String TEXT_724 = NL + "                        ";
  protected final String TEXT_725 = ".errorMessage = e_";
  protected final String TEXT_726 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_727 = ";";
  protected final String TEXT_728 = NL + "                        System.err.print(e_";
  protected final String TEXT_729 = ".getMessage());";
  protected final String TEXT_730 = NL + "            }    \t\t" + NL + "    \t\t";
  ...
  protected final String TEXT_757 = NL + "\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_758 = " = \"Updating\";" + NL + "\t\t\t";
  protected final String TEXT_759 = NL + "    \t\tpstmt_";
  protected final String TEXT_760 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_761 = "++;" + NL + "    \t\t";
  protected final String TEXT_762 = NL + "\t\t\t";
  protected final String TEXT_763 = NL + "\t\t\t\tdataOperationSuffix_";
  protected final String TEXT_764 = " = \" to the ";
  protected final String TEXT_765 = " batch\";" + NL + "\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_766 = " = \"Adding\";" + NL + "\t\t\t";
  protected final String TEXT_767 = NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_768 = "++;" + NL + "    \t\t";
  protected final String TEXT_769 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_770 = NL + "             try {" + NL + "                nb_line_";
  protected final String TEXT_771 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_772 = NL + "\t\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_773 = " = \"Updating\";" + NL + "\t\t\t\t";
  protected final String TEXT_774 = NL + "                updatedCount_";
  protected final String TEXT_775 = " = updatedCount_";
  protected final String TEXT_776 = " + pstmt_";
  protected final String TEXT_777 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_778 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_779 = " = true;";
  protected final String TEXT_780 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_781 = " - \" + e_";
  protected final String TEXT_782 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_783 = NL + "                    throw(e_";
  protected final String TEXT_784 = ");";
  protected final String TEXT_785 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_786 = " - \" + e_";
  protected final String TEXT_787 = ".getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_811 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_812 = " = pstmt_";
  protected final String TEXT_813 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_814 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_815 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_816 = " = rs_";
  protected final String TEXT_817 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_843 = NL + "\t\t\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_844 = " = \"Updating\";" + NL + "\t\t\t\t\t";
  protected final String TEXT_845 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_846 = " = updatedCount_";
  protected final String TEXT_847 = " + pstmtUpdate_";
  protected final String TEXT_848 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_849 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_850 = " = true;";
  protected final String TEXT_851 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_852 = " - \" + e_";
  protected final String TEXT_853 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_854 = NL + "                        throw(e_";
  protected final String TEXT_855 = ");";
  protected final String TEXT_856 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_857 = " - \" + e_";
  protected final String TEXT_858 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_859 = NL + "                            ";
  protected final String TEXT_860 = " = new ";
  protected final String TEXT_861 = "Struct();";
  protected final String TEXT_862 = NL + "                                ";
  protected final String TEXT_863 = ".";
  protected final String TEXT_864 = " = ";
  protected final String TEXT_865 = ".";
  protected final String TEXT_866 = ";";
  protected final String TEXT_867 = NL + "                            rejectedCount_";
  protected final String TEXT_868 = " = rejectedCount_";
  protected final String TEXT_869 = " + 1;";
  protected final String TEXT_870 = NL + "                            ";
  protected final String TEXT_871 = ".errorMessage = e_";
  protected final String TEXT_872 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_873 = ";";
  protected final String TEXT_874 = NL + "                            System.err.print(e_";
  protected final String TEXT_875 = ".getMessage());";
  protected final String TEXT_876 = NL + "                }" + NL + "    \t\t} else {";
  protected final String TEXT_877 = NL + "                        ";
  protected final String TEXT_878 = NL + "                            query_";
  protected final String TEXT_879 = " = ";
  protected final String TEXT_880 = ";";
  protected final String TEXT_881 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_890 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_891 = NL + "\t\t\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_892 = " = \"Inserting\";" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_896 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_897 = ") {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_905 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_906 = " - \" + e_";
  protected final String TEXT_907 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_920 = ".errorMessage = e_";
  protected final String TEXT_921 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_922 = ";";
  protected final String TEXT_923 = NL + "                            System.err.print(e_";
  protected final String TEXT_924 = ".getMessage());";
  protected final String TEXT_925 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_926 = "++;" + NL + "    \t\t";
  protected final String TEXT_927 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_953 = NL + "    " + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_954 = NL + "\t\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_955 = " = \"Updating\";" + NL + "\t\t\t\t";
  protected final String TEXT_956 = NL + "                updateFlag_";
  protected final String TEXT_957 = " = pstmtUpdate_";
  protected final String TEXT_958 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_959 = " = updatedCount_";
  protected final String TEXT_960 = "+updateFlag_";
  protected final String TEXT_961 = ";" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_962 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_963 = " = true;";
  protected final String TEXT_964 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_965 = " - \" + e_";
  protected final String TEXT_966 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_967 = NL + "                    throw(e_";
  protected final String TEXT_968 = ");";
  protected final String TEXT_969 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_970 = " - \" + e_";
  protected final String TEXT_971 = ".getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_980 = NL + "                        rejectedCount_";
  protected final String TEXT_981 = " = rejectedCount_";
  protected final String TEXT_982 = " + 1;";
  protected final String TEXT_983 = NL + "                        ";
  protected final String TEXT_984 = ".errorMessage = e_";
  protected final String TEXT_985 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_986 = ";";
  protected final String TEXT_987 = NL + "                        System.err.print(e_";
  protected final String TEXT_988 = ".getMessage());";
  protected final String TEXT_989 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_990 = " == 0) {" + NL + "            " + NL + "\t\t\t\t";
  protected final String TEXT_991 = NL + "\t\t\t\tquery_";
  protected final String TEXT_992 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_1006 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_1007 = NL + "\t\t\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_1008 = " = \"Inserting\";" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_1012 = ".executeUpdate();" + NL + "                   " + NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_1013 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_1014 = " = true;";
  protected final String TEXT_1015 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_1016 = " - \" + e_";
  protected final String TEXT_1017 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1018 = NL + "                        throw(e_";
  protected final String TEXT_1019 = ");";
  protected final String TEXT_1020 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_1021 = " - \" + e_";
  protected final String TEXT_1022 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_1035 = ".errorMessage = e_";
  protected final String TEXT_1036 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1037 = ";";
  protected final String TEXT_1038 = NL + "                            System.err.print(e_";
  protected final String TEXT_1039 = ".getMessage());";
  protected final String TEXT_1040 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_1056 = NL + "\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_1057 = " = \"Deleting\";" + NL + "\t\t\t";
  protected final String TEXT_1058 = NL + "    \t\tpstmt_";
  protected final String TEXT_1059 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_1060 = NL + "\t\t\t  ";
  protected final String TEXT_1061 = NL + "\t\t\t\tdataOperationSuffix_";
  protected final String TEXT_1062 = " = \" to the ";
  protected final String TEXT_1063 = " batch\";" + NL + "\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_1064 = " = \"Adding\";" + NL + "\t\t\t  ";
  protected final String TEXT_1065 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_1066 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_1067 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_1068 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_1069 = NL + "\t\t\t\t\tdataOperationPrefix_";
  protected final String TEXT_1070 = " = \"Deleting\";" + NL + "\t\t\t\t";
  protected final String TEXT_1071 = NL + "                deletedCount_";
  protected final String TEXT_1072 = " = deletedCount_";
  protected final String TEXT_1073 = " + pstmt_";
  protected final String TEXT_1074 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_1075 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_1076 = " = true;";
  protected final String TEXT_1077 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_1078 = " - \" + e_";
  protected final String TEXT_1079 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_1080 = NL + "                    throw(e_";
  protected final String TEXT_1081 = ");";
  protected final String TEXT_1082 = NL + "\t\t    \t\t\tlog.error(\"";
  protected final String TEXT_1083 = " - \" + e_";
  protected final String TEXT_1084 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_1085 = NL + "                        ";
  protected final String TEXT_1086 = " = new ";
  protected final String TEXT_1087 = "Struct();";
  ...
  protected final String TEXT_1093 = NL + "                        rejectedCount_";
  protected final String TEXT_1094 = " = rejectedCount_";
  protected final String TEXT_1095 = " + 1;";
  protected final String TEXT_1096 = NL + "                        ";
  protected final String TEXT_1097 = ".errorMessage = e_";
  protected final String TEXT_1098 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1099 = ";";
  protected final String TEXT_1100 = NL + "                        System.err.print(e_";
  protected final String TEXT_1101 = ".getMessage());";
  protected final String TEXT_1102 = NL + "            }    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_1103 = NL + "            nb_line_";
  protected final String TEXT_1104 = "++;" + NL + "    \t";
  protected final String TEXT_1105 = NL + "                log4jSb_";
  protected final String TEXT_1106 = ".append(";
  protected final String TEXT_1107 = ".";
  protected final String TEXT_1108 = ");";
  protected final String TEXT_1109 = NL + "                \tlog4jSb_";
  protected final String TEXT_1110 = ".append(\"|\");";
  protected final String TEXT_1111 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_1112 = " - \" + dataOperationPrefix_";
  protected final String TEXT_1113 = " + \" the record \" + nb_line_";
  protected final String TEXT_1114 = " + dataOperationSuffix_";
  protected final String TEXT_1115 = " + \".\");" + NL + "\t\t\tlog.trace(\"";
  protected final String TEXT_1116 = " - Content of the record \" + nb_line_";
  protected final String TEXT_1117 = " + \": \" + log4jSb_";
  protected final String TEXT_1118 = ");" + NL + "\t\t\tlog4jSb_";
  protected final String TEXT_1119 = ".delete(0,log4jSb_";
  protected final String TEXT_1120 = ".length());" + NL + "\t\t";
  protected final String TEXT_1121 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1132 = "                                                " + NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_1133 = " <= batchSizeCounter_";
  protected final String TEXT_1134 = ") {                " + NL + "                \ttry {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1135 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_1136 = " - Executing the ";
  protected final String TEXT_1137 = " batch.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1138 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_1139 = ".executeBatch();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1140 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_1141 = " - The ";
  protected final String TEXT_1142 = " batch execution has succeeded.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1143 = NL + "                \t}catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1144 = "){" + NL + "                \t";
  protected final String TEXT_1145 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_1146 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_1147 = " - \" + e_";
  protected final String TEXT_1148 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1149 = NL + "                \t\tthrow(e_";
  protected final String TEXT_1150 = ");" + NL + "                \t";
  protected final String TEXT_1151 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_1152 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_1153 = " - \" + e_";
  protected final String TEXT_1154 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1155 = NL + "                \t\tSystem.err.println(e_";
  protected final String TEXT_1156 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_1157 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_1158 = " = pstmt_";
  protected final String TEXT_1159 = ".getUpdateCount();                \t" + NL + "        \t    \t";
  ...
  protected final String TEXT_1166 = "      " + NL + "        \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1167 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1168 = ":0);                   \t    \t" + NL + "        \t    \tbatchSizeCounter_";
  protected final String TEXT_1169 = " = 0;             \t                \t                \t" + NL + "    \t\t\t}" + NL + "\t    \t\t";
  protected final String TEXT_1170 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1171 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_1172 = " <= commitCounter_";
  protected final String TEXT_1173 = ") {" + NL + "                " + NL + "\t                ";
  protected final String TEXT_1174 = NL + "\t\t                try {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_1175 = NL + "\t\t\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_1176 = " - Executing the ";
  protected final String TEXT_1177 = " batch.\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_1178 = NL + "\t\t                \t\tpstmt_";
  protected final String TEXT_1179 = ".executeBatch();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_1180 = NL + "\t\t\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_1181 = " - The ";
  protected final String TEXT_1182 = " batch execution has succeeded.\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_1183 = NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1184 = "){" + NL + "\t\t                \t";
  protected final String TEXT_1185 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_1186 = NL + "\t\t\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_1187 = " - \" + e_";
  protected final String TEXT_1188 = ".getMessage());" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_1189 = NL + "\t\t\t\t\t\t\t\tthrow(e_";
  protected final String TEXT_1190 = ");" + NL + "\t\t                \t";
  protected final String TEXT_1191 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_1192 = NL + "\t\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_1193 = " - \" + e_";
  protected final String TEXT_1194 = ".getMessage());" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_1195 = NL + "\t\t                        System.out.println(e_";
  protected final String TEXT_1196 = ".getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_1197 = NL + "\t\t                " + NL + "\t\t                }            \t                              " + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_1198 = " = pstmt_";
  protected final String TEXT_1199 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  ...
  protected final String TEXT_1206 = "     " + NL + "\t\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1207 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1208 = ":0);" + NL + "\t                ";
  protected final String TEXT_1209 = NL + "\t\t\t\t\t";
  protected final String TEXT_1210 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_1211 = " - Starting to commit \" + commitCounter_";
  protected final String TEXT_1212 = "+ \" records.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_1213 = NL + "\t\t        \tconn_";
  protected final String TEXT_1214 = ".commit();" + NL + "\t\t\t\t\t";
  protected final String TEXT_1215 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_1216 = " - Commit has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_1217 = "                " + NL + "                \tcommitCounter_";
