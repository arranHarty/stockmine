...
public class TFileInputRegexBeginJava
{
  ...
  protected final String TEXT_17 = ");" + NL + "        }else{" + NL + "        \tthrow new java.lang.Exception(\"The source data should be specified as File Path or InputStream or java.io.Reader!\");" + NL + "        }" + NL + "        String str";
  ...
  protected final String TEXT_102 = "){//line data not matched with given regex parameter" + NL + "        \t\tthrow new java.lang.Exception(\"Line doesn't match: \" + str";
  ...
  protected final String TEXT_137 = "\t\t\t\t\t" + NL + "\t\t\t\t\t" + NL + "    } catch (java.lang.Exception e) {" + NL + "        whetherReject_";
