...
public class TInterbaseInputBeginJava
{
  ...
  protected final String TEXT_213 = " = \"jdbc:interbase://\" + ";
  ...
  protected final String TEXT_231 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_232 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_233 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_234 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_235 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_236 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_244 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  ...
  protected final String TEXT_249 = " = stmt_";
  protected final String TEXT_250 = ".executeQuery(dbquery_";
  protected final String TEXT_251 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_252 = " = rs_";
  protected final String TEXT_253 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_254 = " = rsmd_";
  protected final String TEXT_255 = ".getColumnCount();" + NL;
  protected final String TEXT_256 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_257 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_258 = ".setDbmsId(\"";
  protected final String TEXT_259 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_260 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_261 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_262 = ".add(\"";
  protected final String TEXT_263 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_264 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_265 = " = ";
  protected final String TEXT_266 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_267 = "; i <= rsmd_";
  protected final String TEXT_268 = ".getColumnCount()-";
  protected final String TEXT_269 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_270 = ".contains(rsmd_";
  protected final String TEXT_271 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_272 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_273 = ".setName(rsmd_";
  protected final String TEXT_274 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_275 = ".setDbName(rsmd_";
  protected final String TEXT_276 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_277 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_278 = "\", rsmd_";
  protected final String TEXT_279 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_280 = ".getPrecision(i), rsmd_";
  protected final String TEXT_281 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_282 = ".setDbType(rsmd_";
  protected final String TEXT_283 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_308 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_309 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_310 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_311 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_312 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_313 = NL + "\t\t    while (rs_";
  protected final String TEXT_314 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_315 = "++;" + NL + "\t\t        ";
  protected final String TEXT_316 = NL + "\t\t                        column_index_";
  protected final String TEXT_317 = " = ";
  protected final String TEXT_318 = " + dcg_";
  protected final String TEXT_319 = ".getColumnCount(); " + NL + "\t\t                    ";
  ...
  protected final String TEXT_336 = ".getObject(column_index_";
  protected final String TEXT_337 = ");";
  protected final String TEXT_338 = NL + "\t\t                         ";
  protected final String TEXT_339 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_340 = ".getObject(column_index_";
  protected final String TEXT_341 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_342 = NL + "                                    ";
  protected final String TEXT_343 = ".";
  protected final String TEXT_344 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_354 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_355 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_377 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_378 = ".";
  protected final String TEXT_379 = ", rs_";
  protected final String TEXT_380 = ", fixedColumnCount_";
  protected final String TEXT_381 = ");";
  protected final String TEXT_382 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_383 = ".getObject(column_index_";
  protected final String TEXT_384 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_385 = ".";
  protected final String TEXT_386 = " = new Geometry(sb.toString());";
  protected final String TEXT_387 = NL + "\t\t                          ";
  protected final String TEXT_388 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_389 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_391 = ".append(";
  protected final String TEXT_392 = ".";
  protected final String TEXT_393 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_394 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_395 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_396 = NL + "\t\t\t\t\t";
  protected final String TEXT_397 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_398 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_399 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_400 = " - Content of the record \" + nb_line_";
  protected final String TEXT_401 = " + \": \" + log4jSb_";
  protected final String TEXT_402 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_403 = ".delete(0,log4jSb_";
  protected final String TEXT_404 = ".length());" + NL + "\t\t\t\t\t";
