...
public class TPivotToColumnsDelimitedBeginJava {
  ...
  protected final String TEXT_3 = " = 0;" + NL + "int nb_line_out_";
  protected final String TEXT_4 = " = 0;" + NL + "" + NL + "String fileName_";
  ...
  protected final String TEXT_36 = NL + "\t //create directory only if not exists" + NL + "\tif(directory_";
  protected final String TEXT_37 = " != null && directory_";
  protected final String TEXT_38 = ".trim().length() != 0) {" + NL + "\t    java.io.File dir_";
  protected final String TEXT_39 = " = new java.io.File(directory_";
  protected final String TEXT_40 = ");" + NL + "\t    if(!dir_";
  protected final String TEXT_41 = ".exists()) {" + NL + "\t\tdir_";
  protected final String TEXT_42 = ".mkdirs();" + NL + "\t    }" + NL + "\t}";
  protected final String TEXT_43 = NL + "\tjava.io.FileOutputStream fos_";
  protected final String TEXT_44 = " = null;" + NL + "    java.io.OutputStreamWriter osw_";
  protected final String TEXT_45 = " = null;" + NL + "    java.io.BufferedWriter out";
  protected final String TEXT_46 = " = null;";
  protected final String TEXT_47 = NL + "    com.talend.csv.CSVWriter CsvWriter";
  protected final String TEXT_48 = " =null;";
  protected final String TEXT_49 = NL + "   try{" + NL + "\tout";
  protected final String TEXT_50 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(new java.io.FileOutputStream(fileName_";
  protected final String TEXT_51 = ", false),";
  protected final String TEXT_52 = "));";
  protected final String TEXT_53 = NL + "    CsvWriter";
  protected final String TEXT_54 = " = new com.talend.csv.CSVWriter(out";
  protected final String TEXT_55 = ");" + NL + "    CsvWriter";
  protected final String TEXT_56 = ".setSeparator('";
  protected final String TEXT_57 = "');  " + NL + "    ";
  protected final String TEXT_58 = NL + "    CsvWriter";
  protected final String TEXT_59 = ".setLineEnd(\"";
  protected final String TEXT_60 = "\");";
  protected final String TEXT_61 = NL + "    CsvWriter";
  protected final String TEXT_62 = ".setQuoteChar('";
  protected final String TEXT_63 = "');                " + NL;
  protected final String TEXT_64 = NL + "    CsvWriter";
  protected final String TEXT_65 = ".setEscapeChar('\\\\');";
  protected final String TEXT_66 = NL + "    CsvWriter";
  protected final String TEXT_67 = ".setEscapeChar('";
  protected final String TEXT_68 = "');";
  protected final String TEXT_69 = NL + "\tCsvWriter";
  protected final String TEXT_70 = ".setEscapeChar('";
  protected final String TEXT_71 = "');";
  protected final String TEXT_72 = "    " + NL + "\tCsvWriter";
  protected final String TEXT_73 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.FORCE);   " + NL + NL;
  protected final String TEXT_74 = NL + NL + NL + "java.io.File file";
  protected final String TEXT_75 = " = new java.io.File(fileName_";
  protected final String TEXT_76 = ");" + NL + "" + NL + "boolean pivot_Exists";
  protected final String TEXT_77 = " = false;" + NL + "" + NL + "StringBuilder pivot_Key";
  protected final String TEXT_78 = " = new StringBuilder();" + NL + "" + NL + "java.util.List<String> pivot_Keys";
  protected final String TEXT_79 = " = new java.util.ArrayList<String>();" + NL + "" + NL + "boolean group_Exists";
  protected final String TEXT_80 = " = false;" + NL + "" + NL + "StringBuilder group_Key";
  protected final String TEXT_81 = " = new StringBuilder();" + NL + "" + NL + "java.util.List<java.util.List<String>> group_Keys";
  protected final String TEXT_82 = " = new java.util.ArrayList<java.util.List<String>>();" + NL + "" + NL + "java.util.List<String> gKvalue";
  protected final String TEXT_83 = " = null;" + NL + "" + NL + "java.util.List<String> aggValues";
  protected final String TEXT_84 = " = null;" + NL + "" + NL + "java.util.Map<java.util.List<String>,java.util.List<String>> aggregation";
  protected final String TEXT_85 = " = new java.util.HashMap<java.util.List<String>,java.util.List<String>>();" + NL;
