...
public class TSAPHanaInputBeginJava
{
  ...
  protected final String TEXT_213 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_214 = " + \":\" + ";
  protected final String TEXT_215 = " ;" + NL + "\t\t\tString dbProperties_";
  protected final String TEXT_216 = " = ";
  protected final String TEXT_217 = ";" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_218 = " != null && dbProperties_";
  protected final String TEXT_219 = ".trim().length() > 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_220 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_221 = " + \":\" + ";
  protected final String TEXT_222 = " + \"/?\" + dbProperties_";
  ...
  protected final String TEXT_390 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_391 = ".getObject(column_index_";
  protected final String TEXT_392 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_393 = ".";
  protected final String TEXT_394 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_403 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_404 = NL + "\t\t\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_406 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_407 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_408 = " - Content of the record \" + nb_line_";
  protected final String TEXT_409 = " + \": \" + log4jSb_";
  protected final String TEXT_410 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_411 = ".delete(0,log4jSb_";
  protected final String TEXT_412 = ".length());" + NL + "\t\t\t\t\t";
