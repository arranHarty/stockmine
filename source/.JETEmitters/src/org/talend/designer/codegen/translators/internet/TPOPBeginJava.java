...
public class TPOPBeginJava
{
  ...
  protected final String TEXT_67 = ".open(javax.mail.Folder.READ_WRITE);" + NL + "} catch (java.lang.Exception e){" + NL + "  folder_";
  ...
  protected final String TEXT_158 = ", \"dd-MM-yyyy HH:mm:ss\");" + NL + "        } catch (java.lang.Exception e){" + NL + "          date_";
