...
public class TFirebirdInputBeginJava
{
  ...
  protected final String TEXT_213 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_250 = "\t\t    " + NL + "\t\ttry{";
  ...
  protected final String TEXT_274 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_286 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_311 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_312 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_313 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_314 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_315 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_316 = NL + "\t\t    while (rs_";
  protected final String TEXT_317 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_318 = "++;" + NL + "\t\t        ";
  protected final String TEXT_319 = NL + "\t\t                        column_index_";
  protected final String TEXT_320 = " = ";
  protected final String TEXT_321 = " + dcg_";
  protected final String TEXT_322 = ".getColumnCount(); " + NL + "\t\t                    ";
  ...
  protected final String TEXT_339 = ".getObject(column_index_";
  protected final String TEXT_340 = ");";
  protected final String TEXT_341 = NL + "\t\t                         ";
  protected final String TEXT_342 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_343 = ".getObject(column_index_";
  protected final String TEXT_344 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_345 = NL + "                                    ";
  protected final String TEXT_346 = ".";
  protected final String TEXT_347 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_357 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_358 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_385 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_386 = ".getObject(column_index_";
  protected final String TEXT_387 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_388 = ".";
  protected final String TEXT_389 = " = new Geometry(sb.toString());";
  protected final String TEXT_390 = NL + "\t\t                          ";
  protected final String TEXT_391 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_392 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_393 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_394 = ".append(";
  protected final String TEXT_395 = ".";
  protected final String TEXT_396 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_397 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_398 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\t\t\t";
  protected final String TEXT_400 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_401 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_402 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_403 = " - Content of the record \" + nb_line_";
  protected final String TEXT_404 = " + \": \" + log4jSb_";
  protected final String TEXT_405 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_406 = ".delete(0,log4jSb_";
  protected final String TEXT_407 = ".length());" + NL + "\t\t\t\t\t";
