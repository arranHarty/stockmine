...
public class TJDBCInputBeginJava
{
  ...
  protected final String TEXT_215 = NL + "                stmt_";
  protected final String TEXT_216 = ".setFetchSize(";
  protected final String TEXT_217 = ");";
  protected final String TEXT_218 = "\t\t\t" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_219 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "            if (null != dataSources_";
  ...
  protected final String TEXT_224 = ").getConnection();" + NL + "            } else {" + NL + "\t\t\t    java.lang.Class.forName(";
  protected final String TEXT_225 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_226 = NL + "\t\t        String dbUser_";
  protected final String TEXT_227 = " = ";
  protected final String TEXT_228 = ";" + NL + "\t\t        String dbPwd_";
  protected final String TEXT_229 = " = ";
  protected final String TEXT_230 = ";" + NL + "\t\t        conn_";
  protected final String TEXT_231 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_232 = ",dbUser_";
  protected final String TEXT_233 = ",dbPwd_";
  protected final String TEXT_234 = ");" + NL + "\t\t\t}";
  protected final String TEXT_235 = NL + "            java.util.Date date_";
  protected final String TEXT_236 = " = null;" + NL + "            try{" + NL + "            \tdate_";
  protected final String TEXT_237 = " = rs_";
  protected final String TEXT_238 = ".getTimestamp(column_index_";
  protected final String TEXT_239 = ");" + NL + "            }catch(java.lang.Exception e){" + NL + "            \tdate_";
  protected final String TEXT_240 = " = rs_";
  protected final String TEXT_241 = ".getDate(column_index_";
  ...
  protected final String TEXT_248 = ".wasNull()) {" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_253 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_254 = " = null;";
  protected final String TEXT_255 = NL + "\t\t        conn_";
  protected final String TEXT_256 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_257 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_258 = ") {";
  protected final String TEXT_259 = NL + "\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_260 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_261 = " = dataSources_";
  protected final String TEXT_262 = ".get(";
  protected final String TEXT_263 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_283 = NL + "\t\t    java.sql.ResultSet rs_";
  ...
  protected final String TEXT_343 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_344 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_345 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_346 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_347 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_348 = NL + "\t\t    while (rs_";
  protected final String TEXT_349 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_350 = "++;" + NL + "\t\t        ";
  protected final String TEXT_351 = NL + "\t\t                        column_index_";
  protected final String TEXT_352 = " = ";
  protected final String TEXT_353 = " + dcg_";
  protected final String TEXT_354 = ".getColumnCount(); " + NL + "\t\t                    ";
  protected final String TEXT_355 = NL + "\t\t                        column_index_";
  protected final String TEXT_356 = " = ";
  protected final String TEXT_357 = ";" + NL + "\t\t                    ";
  protected final String TEXT_358 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_370 = " = (List)rs_";
  protected final String TEXT_371 = ".getObject(column_index_";
  protected final String TEXT_372 = ");";
  protected final String TEXT_373 = NL + "\t\t                         ";
  protected final String TEXT_374 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_375 = ".getObject(column_index_";
  protected final String TEXT_376 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_377 = NL + "                                    ";
  protected final String TEXT_378 = ".";
  protected final String TEXT_379 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_389 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_390 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_418 = ".getObject(column_index_";
  ...
  protected final String TEXT_445 = NL + NL + NL;
