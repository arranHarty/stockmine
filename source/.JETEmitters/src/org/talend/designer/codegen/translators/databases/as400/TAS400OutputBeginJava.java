...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_82 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_89 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_99 = " - Create table '\" + tableName_";
  protected final String TEXT_100 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_107 = " - Creating table '\" + tableName_";
  protected final String TEXT_108 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_109 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_110 = ".execute(\"";
  protected final String TEXT_111 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_118 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_279 = " - Creating table '\" + tableName_";
  protected final String TEXT_280 = " + \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_281 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_282 = ".execute(\"";
  protected final String TEXT_283 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_290 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_300 = " - Create table '\" + tableName_";
  protected final String TEXT_301 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_302 = NL + "                    stmtCreate_";
  protected final String TEXT_303 = ".close();            " + NL + "                }                ";
  protected final String TEXT_304 = NL + "                if(whetherExist_";
  protected final String TEXT_305 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_309 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_315 = " - Drop table '\" + tableName_";
  protected final String TEXT_316 = "+ \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_317 = NL + "                    stmtDrop_";
  protected final String TEXT_318 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_322 = " - Creating table '\" + tableName_";
  protected final String TEXT_323 = " + \"'.\" );" + NL + "\t\t\t\t\t";
  protected final String TEXT_324 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_325 = ".execute(\"";
  protected final String TEXT_326 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_333 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_343 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_347 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_348 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  ...
  protected final String TEXT_354 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_360 = "- Clear table '\" + tableName_";
  protected final String TEXT_361 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_362 = NL + "            stmtClear_";
  ...
  protected final String TEXT_373 = " - Trancating table '\" + tableName_";
  protected final String TEXT_374 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_375 = NL + "\t\t\t";
  protected final String TEXT_376 = NL + "\t\t\tconn_";
  protected final String TEXT_377 = ".commit();" + NL + "\t\t\t";
  ...
  protected final String TEXT_382 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_391 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_392 = " = conn_";
  protected final String TEXT_393 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_394 = " = stmtTruncCount_";
  protected final String TEXT_395 = ".executeQuery(\"";
  protected final String TEXT_396 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_400 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_409 = " - Truncate reuse stroage table '\" + tableName_";
  protected final String TEXT_410 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_411 = NL + "             while(rsTruncCount_";
  protected final String TEXT_412 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_416 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_425 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  protected final String TEXT_426 = NL + "\t    String update_";
  protected final String TEXT_427 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_436 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_464 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_468 = NL + "\t    String delete_";
  protected final String TEXT_469 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_475 = NL + "        StringBuffer query_";
  protected final String TEXT_476 = " = null;" + NL + "       \t";
  protected final String TEXT_477 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_487 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_488 = " = insert_";
  protected final String TEXT_489 = ".split(\"\\\\?\");";
  protected final String TEXT_490 = NL + "\t\t\tdelete_";
  protected final String TEXT_491 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_492 = " = delete_";
  protected final String TEXT_493 = ".split(\"\\\\?\");";
  protected final String TEXT_494 = NL + "\t\t\treplace_";
  protected final String TEXT_495 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_496 = " = replace_";
  protected final String TEXT_497 = ".split(\"\\\\?\");";
  protected final String TEXT_498 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_499 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_500 = " = insertIgnore_";
