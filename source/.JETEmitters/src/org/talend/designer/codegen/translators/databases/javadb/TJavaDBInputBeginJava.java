...
public class TJavaDBInputBeginJava
{
  ...
  protected final String TEXT_212 = NL + "\t\t\t\t//set the root path of the database" + NL + "\t\t\t\tSystem.setProperty(\"derby.system.home\", ";
  protected final String TEXT_213 = ");";
  protected final String TEXT_214 = NL + "        \t\t\torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_215 = ";" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_216 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_217 = "),Integer.parseInt(";
  protected final String TEXT_218 = "));" + NL + "        \t\t\t//start server" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_219 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "        \t\t\tboolean isServerUp_";
  protected final String TEXT_220 = " = false;" + NL + "        \t\t\tint timeOut_";
  protected final String TEXT_221 = " = 5;" + NL + "        \t\t\twhile(!isServerUp_";
  protected final String TEXT_222 = " && timeOut_";
  protected final String TEXT_223 = " > 0) {" + NL + "        \t\t\t\ttry {" + NL + "            \t\t\t\ttimeOut_";
  protected final String TEXT_224 = "--;" + NL + "            \t\t\t\t/*" + NL + "    \t\t\t\t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t\t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t\t\t\t*/" + NL + "            \t\t\t\tserverControl_";
  protected final String TEXT_225 = ".ping();" + NL + "            \t\t\t\tisServerUp_";
  protected final String TEXT_226 = " = true;" + NL + "        \t\t\t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t\t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\t\t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t\t\t\t}    \t\t\t\t" + NL + "        \t\t\t}" + NL + "        \t\t\tif(!isServerUp_";
  protected final String TEXT_227 = ") {" + NL + "        \t\t\t\t/*" + NL + "    \t\t\t\t\t * can not obtain a connection to network server." + NL + "    \t\t\t\t\t */ \t " + NL + "        \t\t\t\tSystem.exit(1);\t" + NL + "        \t\t\t}" + NL + "        \t\t\t//derby network server started.";
  protected final String TEXT_228 = NL + "\t\t\t\tString url_";
  protected final String TEXT_229 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_230 = ";";
  protected final String TEXT_231 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_232 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_233 = " + \":\" + ";
  protected final String TEXT_234 = " + \"/\" + ";
  protected final String TEXT_235 = ";";
  protected final String TEXT_236 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_237 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_238 = " + \":\" + ";
  protected final String TEXT_239 = " + \"/\" + ";
  protected final String TEXT_240 = ";";
  protected final String TEXT_241 = NL + "\t\t\t    java.lang.Class.forName(\"";
  protected final String TEXT_242 = "\").newInstance();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_249 = ",dbUser_";
  protected final String TEXT_250 = ",dbPwd_";
  ...
  protected final String TEXT_258 = "\");" + NL + "\t\t        if (null == conn_";
  ...
  protected final String TEXT_269 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_270 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_271 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_272 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_273 = NL + NL + "\t\t    ";
  protected final String TEXT_274 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_275 = " = ";
  protected final String TEXT_276 = ";";
  protected final String TEXT_277 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_278 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_279 = " + \"'.\");";
  protected final String TEXT_280 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_281 = "_QUERY\",dbquery_";
  protected final String TEXT_282 = ");" + NL + "\t\t    ";
  protected final String TEXT_283 = "\t\t    " + NL + "\t\ttry{";
  protected final String TEXT_284 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_285 = " = stmt_";
  protected final String TEXT_286 = ".executeQuery(dbquery_";
  protected final String TEXT_287 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_288 = " = rs_";
  protected final String TEXT_289 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_290 = " = rsmd_";
  protected final String TEXT_291 = ".getColumnCount();" + NL;
  protected final String TEXT_292 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_293 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_294 = ".setDbmsId(\"";
  protected final String TEXT_295 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_296 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_297 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_298 = ".add(\"";
  protected final String TEXT_299 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_300 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_301 = " = ";
  protected final String TEXT_302 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_303 = "; i <= rsmd_";
  protected final String TEXT_304 = ".getColumnCount()-";
  protected final String TEXT_305 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_306 = ".contains(rsmd_";
  protected final String TEXT_307 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_308 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_309 = ".setName(rsmd_";
  protected final String TEXT_310 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_311 = ".setDbName(rsmd_";
  protected final String TEXT_312 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_313 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_314 = "\", rsmd_";
  protected final String TEXT_315 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_316 = ".getPrecision(i), rsmd_";
  protected final String TEXT_317 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_318 = ".setDbType(rsmd_";
  protected final String TEXT_319 = ".getColumnTypeName(i));";
  protected final String TEXT_320 = NL + "                \tdcm_";
  protected final String TEXT_321 = ".setFormat(";
  protected final String TEXT_322 = ");";
  protected final String TEXT_323 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_324 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_325 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_326 = ".setLength(rsmd_";
  protected final String TEXT_327 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_328 = ".setLength(rsmd_";
  protected final String TEXT_329 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_330 = NL + "\t\t\tdcm_";
  protected final String TEXT_331 = ".setLength(rsmd_";
  protected final String TEXT_332 = ".getPrecision(i));";
  protected final String TEXT_333 = NL + "                \tdcm_";
  protected final String TEXT_334 = ".setPrecision(rsmd_";
  protected final String TEXT_335 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_336 = ".setNullable(rsmd_";
  protected final String TEXT_337 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_338 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_339 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_340 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_341 = ".metadatas.add(dcm_";
  protected final String TEXT_342 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_343 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_344 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_345 = " =1;" + NL + "\t\t    ";
  ...
  protected final String TEXT_359 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_371 = " = (List)rs_";
  protected final String TEXT_372 = ".getObject(column_index_";
  protected final String TEXT_373 = ");";
  protected final String TEXT_374 = NL + "\t\t                         ";
  protected final String TEXT_375 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_376 = ".getObject(column_index_";
  protected final String TEXT_377 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_378 = NL + "                                    ";
  protected final String TEXT_379 = ".";
  protected final String TEXT_380 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_390 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_391 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_398 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_399 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_400 = ".getClob(i_";
  protected final String TEXT_401 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_402 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_403 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_404 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_405 = ".add(tNTextImpl_";
  protected final String TEXT_406 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_407 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_408 = ".";
  protected final String TEXT_409 = ", rs_";
  protected final String TEXT_410 = ", fixedColumnCount_";
  protected final String TEXT_411 = ",list_";
  ...
  protected final String TEXT_418 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_419 = ".getObject(column_index_";
  ...
  protected final String TEXT_430 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_431 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_435 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
