...
public class TSalesforceGetDeletedBeginJava
{
  ...
  protected final String TEXT_82 = ".getCalendar();" + NL + "\t\t\t" + NL + "\t        " + NL + "\t        org.talend.salesforce.SforceManagement sfMgr_";
  ...
  protected final String TEXT_126 = "\t\t\t\t" + NL + "\t\t\tcom.salesforce.soap.partner.GetDeletedResult gdr_";
  protected final String TEXT_127 = " = sfMgr_";
  protected final String TEXT_128 = ".getDeleted(";
  protected final String TEXT_129 = ", startCal_";
  protected final String TEXT_130 = ", endCal_";
  protected final String TEXT_131 = ");" + NL + "    \t\tcom.salesforce.soap.partner.QueryResult qr_";
  protected final String TEXT_132 = " = null;" + NL + "    \t\tcom.salesforce.soap.partner.DeletedRecord[] drs_";
  protected final String TEXT_133 = " = gdr_";
  protected final String TEXT_134 = ".getDeletedRecords();" + NL + "    \t\t" + NL + "    \t\tif (drs_";
  protected final String TEXT_135 = " != null && drs_";
  protected final String TEXT_136 = ".length > 0) {" + NL + "    \t\t\tint batchSize_";
  protected final String TEXT_137 = " = 500;" + NL + "    \t\t\tint count_";
  protected final String TEXT_138 = " = 0;" + NL + "    \t\t\tStringBuilder soql_";
  protected final String TEXT_139 = " = new StringBuilder();" + NL + "    \t\t\tString soqlBase_";
  protected final String TEXT_140 = " = \"SELECT \" + \"";
  protected final String TEXT_141 = "\" + \" FROM \" + ";
  protected final String TEXT_142 = " + \" WHERE \";" + NL + "\t\t\t\tfor(com.salesforce.soap.partner.DeletedRecord dr_";
  protected final String TEXT_143 = " : drs_";
  protected final String TEXT_144 = "){" + NL + "\t\t\t\t\tcount_";
  protected final String TEXT_145 = "++;" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_146 = " ++;" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tsoql_";
  protected final String TEXT_147 = ".append(\"Id='\"+dr_";
  protected final String TEXT_148 = ".getId().getID()+\"'\");" + NL + "\t\t\t\t\tsoql_";
  protected final String TEXT_149 = ".append(\" or \");" + NL + "\t\t\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\t\t\tif((soql_";
  protected final String TEXT_151 = ".length() > (10000 - 23 - soqlBase_";
  protected final String TEXT_152 = ".length())) || count_";
  protected final String TEXT_153 = " == drs_";
  protected final String TEXT_154 = ".length){" + NL + "\t\t\t\t\t\tsoql_";
  protected final String TEXT_155 = ".delete(soql_";
  protected final String TEXT_156 = ".length() - 4, soql_";
  protected final String TEXT_157 = ".length());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\t\t\t\tSystem.out.println(soqlBase_";
  protected final String TEXT_159 = " + soql_";
  protected final String TEXT_160 = ".toString());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_161 = NL + "\t\t\t\t\t\tqr_";
  protected final String TEXT_162 = " = sfMgr_";
  protected final String TEXT_163 = ".queryAll(soqlBase_";
  protected final String TEXT_164 = " + soql_";
  protected final String TEXT_165 = ".toString(),batchSize_";
  protected final String TEXT_166 = ");" + NL + "" + NL + "\t\t\t\t\t\tboolean bContinue_";
  protected final String TEXT_167 = " = true;" + NL + "\t\t\t\t\t\twhile (bContinue_";
  protected final String TEXT_168 = " && qr_";
  protected final String TEXT_169 = " != null && qr_";
  protected final String TEXT_170 = ".getRecords() != null) {" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t        \t\t    for(int i_";
  protected final String TEXT_171 = " = 0; i_";
  protected final String TEXT_172 = " < qr_";
  protected final String TEXT_173 = ".getRecords().length; i_";
  protected final String TEXT_174 = "++){" + NL + "\t\t\t        \t\t\torg.apache.axiom.om.OMElement[] fields_";
  protected final String TEXT_175 = " = qr_";
  protected final String TEXT_176 = ".getRecords()[i_";
  protected final String TEXT_177 = "].getExtraElement();" + NL + "\t\t\t" + NL + "\t\t\t\t\t\t\t\tint len_";
  protected final String TEXT_178 = " = fields_";
  protected final String TEXT_179 = ".length;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_180 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\tif (";
  protected final String TEXT_181 = " < len_";
  protected final String TEXT_182 = " && fields_";
  protected final String TEXT_183 = "[";
  protected final String TEXT_184 = "].getText() != null && !\"\".equals(fields_";
  protected final String TEXT_185 = "[";
  protected final String TEXT_186 = "].getText())){" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_187 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_188 = ".";
  protected final String TEXT_189 = " = fields_";
  protected final String TEXT_190 = "[";
  protected final String TEXT_191 = "].getText();" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_192 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_193 = ".";
  protected final String TEXT_194 = " = ParserUtils.parseTo_Date(fields_";
  protected final String TEXT_195 = "[";
  protected final String TEXT_196 = "].getText(), ";
  protected final String TEXT_197 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_198 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_199 = ".";
  protected final String TEXT_200 = " = fields_";
  protected final String TEXT_201 = "[";
  protected final String TEXT_202 = "].getText().getBytes();" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_203 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_204 = ".";
  protected final String TEXT_205 = " = ParserUtils.parseTo_";
  protected final String TEXT_206 = "(fields_";
