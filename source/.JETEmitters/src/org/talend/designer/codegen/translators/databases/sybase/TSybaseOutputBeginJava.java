...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_98 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_108 = " - Create table '\" + tableName_";
  protected final String TEXT_109 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_114 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_115 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_116 = " - Creating table '\" + tableName_";
  protected final String TEXT_117 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_119 = ".execute(\"";
  protected final String TEXT_120 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_226 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_227 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_236 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_237 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_238 = " == null || dbschema_";
  protected final String TEXT_239 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_240 = " = conn_";
  protected final String TEXT_241 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_242 = " = stmtSchema_";
  protected final String TEXT_243 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_244 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_245 = " = rsSchema_";
  protected final String TEXT_246 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_247 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_248 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_263 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_264 = ".equals";
  protected final String TEXT_265 = "IgnoreCase";
  protected final String TEXT_266 = "(schema_";
  ...
  protected final String TEXT_284 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_288 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_335 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_342 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_445 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_463 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_478 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_514 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_515 = " = conn_";
  protected final String TEXT_516 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_517 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_518 = " +\" ON\");" + NL + "\t    ";
