...
public class TMSAXOutputMainJava
{
  ...
  protected final String TEXT_117 = "++;" + NL + "            \t}" + NL + "            }catch(java.lang.Exception e){" + NL + "                whetherReject_";
  ...
  protected final String TEXT_148 = "++;" + NL + "            }catch(java.lang.Exception e)" + NL + "            {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_193 = "++;" + NL + "        }catch(java.lang.Exception e)" + NL + "        {" + NL + "            whetherReject_";
  ...
  protected final String TEXT_225 = "++;" + NL + "            }catch(java.lang.Exception e){" + NL + "                whetherReject_";
  ...
  protected final String TEXT_252 = NL + "    }catch(java.lang.Exception e){" + NL + "        whetherReject_";
