...
public class TNetezzaOutputBeginJava {
  ...
  protected final String TEXT_138 = NL + "\tjava.lang.Class.forName(\"";
  protected final String TEXT_139 = "\");" + NL + "\t";
  protected final String TEXT_140 = NL + "\t    String url_";
  protected final String TEXT_141 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_142 = " + \":\" + ";
  protected final String TEXT_143 = " + \"/\" + ";
  protected final String TEXT_144 = ";" + NL + "\t    ";
  protected final String TEXT_145 = NL + "\t    String url_";
  protected final String TEXT_146 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_147 = " + \":\" + ";
  protected final String TEXT_148 = " + \"/\" + ";
  protected final String TEXT_149 = " + \"?\" + ";
  protected final String TEXT_150 = ";" + NL + "\t    ";
  protected final String TEXT_151 = NL + "\tString dbUser_";
  protected final String TEXT_152 = " = ";
  protected final String TEXT_153 = ";" + NL + "\tString dbPwd_";
  protected final String TEXT_154 = " = ";
  protected final String TEXT_155 = ";" + NL + "\t";
  protected final String TEXT_156 = "\t " + NL + "\t";
  protected final String TEXT_157 = NL + "\t\tlog.info(\"";
  protected final String TEXT_158 = " - Connection attempt to '\" + url_";
  protected final String TEXT_159 = " + \"' with the username '\" + dbUser_";
  protected final String TEXT_160 = " + \"'.\");" + NL + "\t";
  protected final String TEXT_161 = "\t" + NL + "\tconn_";
  protected final String TEXT_162 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_163 = ", dbUser_";
  protected final String TEXT_164 = ", dbPwd_";
  protected final String TEXT_165 = ");" + NL + "\t";
  protected final String TEXT_166 = NL + "\t\tlog.info(\"";
  protected final String TEXT_167 = " - Connection to '\" + url_";
  ...
  protected final String TEXT_174 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_180 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_186 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_192 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_204 = " - Creata table '\" + tableName_";
  ...
  protected final String TEXT_217 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_223 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_229 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_235 = ".createStatement();" + NL + "\t\t        \t";
  protected final String TEXT_236 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_237 = " - Droping tableName_";
  protected final String TEXT_238 = "!\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_239 = NL + "                    stmtDrop_";
  protected final String TEXT_240 = ".execute(\"";
  protected final String TEXT_241 = "\");" + NL + "\t\t        \t";
  protected final String TEXT_242 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_243 = " - Drop table '\" + tableName_";
  protected final String TEXT_244 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_245 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_257 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_258 = " = conn_";
  protected final String TEXT_259 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_260 = " = stmtClearCount_";
  ...
  protected final String TEXT_266 = " - Truncating table '\" + tableName_";
  ...
  protected final String TEXT_272 = " - Truncate table '\" + tableName_";
  protected final String TEXT_273 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_274 = NL + "            while(rsClearCount_";
  protected final String TEXT_275 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_276 = " += rsClearCount_";
  protected final String TEXT_277 = ".getInt(1);" + NL + "            }";
  ...
  protected final String TEXT_282 = " - Clearing table '\" + tableName_";
  protected final String TEXT_283 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_284 = NL + "            deletedCount_";
  protected final String TEXT_285 = " = deletedCount_";
  protected final String TEXT_286 = " + stmtClear_";
  ...
  protected final String TEXT_295 = ".setAutoCommit(false);";
  protected final String TEXT_296 = "      \t    " + NL + "\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_297 = " = conn_";
  protected final String TEXT_298 = ".prepareStatement(\"INSERT INTO \"+";
  protected final String TEXT_299 = "+\" (";
  protected final String TEXT_300 = ") VALUES (";
  protected final String TEXT_301 = ")\");\t        " + NL + "\t        ";
  protected final String TEXT_302 = NL + "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_303 = " = conn_";
  protected final String TEXT_304 = ".prepareStatement(\"UPDATE \" + ";
  ...
  protected final String TEXT_310 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_311 = " + \" WHERE ";
  protected final String TEXT_312 = "\");\t" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_313 = " = conn_";
  protected final String TEXT_314 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_315 = " + \" (";
  protected final String TEXT_316 = ") VALUES (";
  protected final String TEXT_317 = ")\");" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_318 = " = conn_";
  protected final String TEXT_319 = ".prepareStatement(\"UPDATE \" + ";
  ...
  protected final String TEXT_325 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_326 = " + \" SET ";
  protected final String TEXT_327 = " WHERE ";
  protected final String TEXT_328 = "\");" + NL + "" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_329 = " = conn_";
  protected final String TEXT_330 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_331 = " + \" (";
  protected final String TEXT_332 = ") VALUES (";
  protected final String TEXT_333 = ")\");" + NL + "\t\t\t\t" + NL + "\t    ";
  protected final String TEXT_334 = NL + "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_335 = " = conn_";
  protected final String TEXT_336 = ".prepareStatement(\"DELETE  FROM \" + ";
  protected final String TEXT_337 = " + \" WHERE ";
  protected final String TEXT_338 = "\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_339 = NL + NL + "\t    int commitEvery_";
  protected final String TEXT_340 = " = ";
  protected final String TEXT_341 = ";" + NL + "" + NL + "\t    int commitCounter_";
  protected final String TEXT_342 = " = 0;" + NL + "" + NL + "\t";
  protected final String TEXT_343 = NL + "\t   int batchSize_";
  protected final String TEXT_344 = " = ";
  protected final String TEXT_345 = ";" + NL + "\t   int batchSizeCounter_";
