...
public class TMarketoInputBeginJava
{
  ...
  protected final String TEXT_153 = " = new com.marketo.www.mktows.StreamPosition();" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_154 = NL + "\t\t\t\tjava.text.SimpleDateFormat oldestcreatedat_";
  protected final String TEXT_155 = " = new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss Z\");" + NL + "\t\t\t\tif(";
  protected final String TEXT_156 = " != null){" + NL + "\t\t        \toldestcreatedat_";
  protected final String TEXT_157 = ".parse(";
  protected final String TEXT_158 = ");" + NL + "\t\t            java.util.Calendar calendar_oldestcreatedat_";
  protected final String TEXT_159 = " = oldestcreatedat_";
  protected final String TEXT_160 = ".getCalendar();" + NL + "\t\t            streamPosition_";
  protected final String TEXT_161 = ".setOldestCreatedAt(calendar_oldestcreatedat_";
  protected final String TEXT_162 = ");" + NL + "\t            }";
  protected final String TEXT_163 = NL + "\t            java.text.SimpleDateFormat latestcreatedat_";
  protected final String TEXT_164 = " = new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss Z\");" + NL + "\t            if(";
  protected final String TEXT_165 = " != null){" + NL + "\t\t        \tlatestcreatedat_";
  protected final String TEXT_166 = ".parse(";
  protected final String TEXT_167 = ");" + NL + "\t\t            java.util.Calendar calendar_latestcreatedat_";
  protected final String TEXT_168 = " = latestcreatedat_";
  protected final String TEXT_169 = ".getCalendar();" + NL + "\t\t            streamPosition_";
  protected final String TEXT_170 = ".setLatestCreatedAt(calendar_latestcreatedat_";
  protected final String TEXT_171 = ");" + NL + "\t\t        }";
  protected final String TEXT_172 = NL + "            " + NL + "            com.marketo.www.mktows.LastUpdateAtSelector leadSelector_";
  protected final String TEXT_173 = " = new com.marketo.www.mktows.LastUpdateAtSelector();" + NL + "            ";
  protected final String TEXT_174 = NL + "\t\t\t\tjava.text.SimpleDateFormat oldestupdatedat_";
  protected final String TEXT_175 = " = new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss Z\");" + NL + "\t\t\t\tif(";
  protected final String TEXT_176 = " != null){" + NL + "\t\t        \toldestupdatedat_";
  protected final String TEXT_177 = ".parse(";
  protected final String TEXT_178 = ");" + NL + "\t\t            java.util.Calendar calendar_oldestupdatedat_";
  protected final String TEXT_179 = " = oldestupdatedat_";
  protected final String TEXT_180 = ".getCalendar();" + NL + "\t\t            leadSelector_";
  protected final String TEXT_181 = ".setOldestUpdatedAt(calendar_oldestupdatedat_";
  protected final String TEXT_182 = ");" + NL + "\t            }";
  protected final String TEXT_183 = NL + "\t            java.text.SimpleDateFormat latestupdatedat_";
  protected final String TEXT_184 = " = new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss Z\");" + NL + "\t            if(";
  protected final String TEXT_185 = " != null){" + NL + "\t\t        \tlatestupdatedat_";
  protected final String TEXT_186 = ".parse(";
  protected final String TEXT_187 = ");" + NL + "\t\t            java.util.Calendar calendar_latestupdatedat_";
  protected final String TEXT_188 = " = latestupdatedat_";
  protected final String TEXT_189 = ".getCalendar();" + NL + "\t\t            leadSelector_";
  protected final String TEXT_190 = ".setLatestUpdatedAt(calendar_latestupdatedat_";
  protected final String TEXT_191 = ");" + NL + "\t\t        }";
  protected final String TEXT_192 = NL + "            " + NL + "            " + NL + "            while(true){" + NL + "                com.marketo.www.mktows.ResultGetLeadChanges changes_";
  protected final String TEXT_193 = " = null;" + NL + "                try{" + NL + "                \tchanges_";
  protected final String TEXT_194 = " = client_";
  protected final String TEXT_195 = ".getLeadChanges(";
  protected final String TEXT_196 = ", includeTypes_";
  protected final String TEXT_197 = ", excludeTypes_";
  protected final String TEXT_198 = ", streamPosition_";
  protected final String TEXT_199 = ", leadSelector_";
  protected final String TEXT_200 = ");" + NL + "                \tglobalMap.put(\"";
  protected final String TEXT_201 = "_NB_CALL\",++nb_call_";
  protected final String TEXT_202 = ");" + NL + "                }catch(java.lang.Exception ex_";
  protected final String TEXT_203 = "){" + NL + "                \tif(ex_";
  protected final String TEXT_204 = " instanceof org.apache.axis.AxisFault){" + NL + "            \t\t\tif(!client_";
  protected final String TEXT_205 = ".isSystemError((org.apache.axis.AxisFault)ex_";
  ...
  protected final String TEXT_211 = NL + "\t\t\t        \tSystem.err.println(ex_";
  protected final String TEXT_212 = ".getMessage());" + NL + "\t\t\t\t        break;" + NL + "\t\t\t        ";
  protected final String TEXT_213 = NL + "\t\t\t\t}" + NL + "                if(changes_";
  protected final String TEXT_214 = " != null){" + NL + "\t                com.marketo.www.mktows.LeadChangeRecord[] changeRecords_";
  protected final String TEXT_215 = " = changes_";
  protected final String TEXT_216 = ".getLeadChangeRecordList();" + NL + "\t                for (int i_";
  protected final String TEXT_217 = " = 0; i_";
  protected final String TEXT_218 = " < changes_";
  protected final String TEXT_219 = ".getReturnCount(); i_";
  protected final String TEXT_220 = "++) {" + NL + "\t                    java.util.Map<String, String> result_";
  protected final String TEXT_221 = " = client_";
  protected final String TEXT_222 = ".readChange(changeRecords_";
  protected final String TEXT_223 = "[i_";
  protected final String TEXT_224 = "]);";
  protected final String TEXT_225 = NL + "\t\t\t\tif(result_";
  protected final String TEXT_226 = ".get(";
  protected final String TEXT_227 = ")!=null){" + NL + "    \t\t\t";
  protected final String TEXT_228 = "\t\t\t\t" + NL + "    \t\t\t\t\t";
  protected final String TEXT_229 = ".";
  protected final String TEXT_230 = " = result_";
  protected final String TEXT_231 = ".get(";
  protected final String TEXT_232 = ");" + NL + "    \t\t\t";
  protected final String TEXT_233 = NL + "    \t\t\t\t\t";
  protected final String TEXT_234 = ".";
  protected final String TEXT_235 = " = ParserUtils.parseTo_Date(result_";
  ...
  protected final String TEXT_249 = NL + NL + NL + NL + "        ";
