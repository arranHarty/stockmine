...
public class TRedshiftInputBeginJava
{
  ...
  protected final String TEXT_213 = " > 0) {" + NL + "\t\t\t\t\tjava.io.Writer output_";
  protected final String TEXT_214 = " = new java.io.FileWriter(";
  protected final String TEXT_215 = ", true);" + NL + "\t\t\t\t\tjava.sql.DriverManager.setLogWriter(new java.io.PrintWriter(output_";
  protected final String TEXT_216 = ",true));" + NL + "\t\t\t\t}\t\t\t\t" + NL + "\t\t\torg.postgresql.Driver.setLogLevel(";
  protected final String TEXT_217 = ");" + NL + "" + NL + "\t\t\tString url_";
  protected final String TEXT_218 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_219 = " + \":\" + ";
  protected final String TEXT_220 = " + \"/\" + ";
  protected final String TEXT_221 = " +\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_222 = "+\"&protocolVersion=3\";";
  protected final String TEXT_223 = NL + "\t\t\t\tconn_";
  protected final String TEXT_224 = ".setAutoCommit(false);";
  protected final String TEXT_225 = NL + "                stmt_";
  protected final String TEXT_226 = ".setFetchSize(";
  ...
  protected final String TEXT_244 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_245 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_246 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_247 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_248 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_249 = NL + NL + "\t\t    ";
  protected final String TEXT_250 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_251 = " = ";
  protected final String TEXT_252 = ";";
  protected final String TEXT_253 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_254 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_255 = " + \"'.\");";
  protected final String TEXT_256 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_257 = "_QUERY\",dbquery_";
  protected final String TEXT_258 = ");" + NL + "\t\t    ";
  protected final String TEXT_259 = "\t\t    " + NL + "\t\ttry{";
