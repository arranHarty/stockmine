...
public class TMDMRouteRecordMainJava
{
  ...
  protected final String TEXT_27 = "\");" + NL + "" + NL + "org.talend.mdm.webservice.WSRouteItemV2 wsRouteItem_";
  protected final String TEXT_28 = " = new org.talend.mdm.webservice.WSRouteItemV2();" + NL + "org.talend.mdm.webservice.WSItemPK wsItemPK_";
  protected final String TEXT_29 = " = new org.talend.mdm.webservice.WSItemPK();" + NL + "wsItemPK_";
  protected final String TEXT_30 = ".setConceptName(";
  protected final String TEXT_31 = ");" + NL + "wsItemPK_";
  protected final String TEXT_32 = ".setWsDataClusterPK(dataCluster_";
  protected final String TEXT_33 = ");" + NL + "wsItemPK_";
  protected final String TEXT_34 = ".setIds(new String[]{";
  protected final String TEXT_35 = NL;
  protected final String TEXT_36 = NL + "});" + NL + "wsRouteItem_";
  protected final String TEXT_37 = ".setWsItemPK(wsItemPK_";
  protected final String TEXT_38 = ");" + NL + "org.talend.mdm.webservice.WSRoutingRulePK[] wsRoutingRulePKArray_";
  protected final String TEXT_39 = " = xtentisWS_";
  protected final String TEXT_40 = ".routeItemV2(wsRouteItem_";
