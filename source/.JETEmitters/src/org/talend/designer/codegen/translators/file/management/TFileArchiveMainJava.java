...
public class TFileArchiveMainJava
{
  ...
  protected final String TEXT_9 = ").exists()){" + NL + "    \tthrow(new java.lang.Exception(\"File already exist!\"));" + NL + "    }";
  ...
  protected final String TEXT_76 = ".setUseZip64(org.apache.commons.compress.archivers.zip.Zip64Mode.Always);";
  protected final String TEXT_77 = NL + "        out_";
  protected final String TEXT_78 = ".setUseZip64(org.apache.commons.compress.archivers.zip.Zip64Mode.Never);";
  protected final String TEXT_79 = NL + "        // here get the file list" + NL + "        for (int i_";
  protected final String TEXT_80 = " = 0; i_";
  protected final String TEXT_81 = " < list_";
  protected final String TEXT_82 = ".size(); i_";
  protected final String TEXT_83 = "++) {" + NL + "            java.io.BufferedInputStream in_";
  protected final String TEXT_84 = " = new java.io.BufferedInputStream(new java.io.FileInputStream(list_";
  protected final String TEXT_85 = ".get(i_";
  protected final String TEXT_86 = ")));" + NL + "            org.apache.commons.compress.archivers.zip.ZipArchiveEntry entry = new org.apache.commons.compress.archivers.zip.ZipArchiveEntry(list_";
  protected final String TEXT_87 = ".get(i_";
  protected final String TEXT_88 = ").getPath().substring(beginIndex_";
  protected final String TEXT_89 = "));    " + NL + "            entry.setTime(list_";
  protected final String TEXT_90 = ".get(i_";
  protected final String TEXT_91 = ").lastModified()); " + NL + "            out_";
  protected final String TEXT_92 = ".putArchiveEntry(entry);   " + NL + "           " + NL + "            int readLen_";
  protected final String TEXT_93 = ";" + NL + "            byte[] buf_";
  protected final String TEXT_94 = "=new byte[1024];     " + NL + "            while ((readLen_";
  protected final String TEXT_95 = " = in_";
  protected final String TEXT_96 = ".read(buf_";
  protected final String TEXT_97 = ",0,1024)) != -1)  {    " + NL + "                  out_";
  protected final String TEXT_98 = ".write(buf_";
  protected final String TEXT_99 = ", 0, readLen_";
  protected final String TEXT_100 = ");    " + NL + "            }    " + NL + "            out_";
  protected final String TEXT_101 = ".closeArchiveEntry();" + NL + "            out_";
  protected final String TEXT_102 = ".flush();    " + NL + "            in_";
  protected final String TEXT_103 = ".close();       " + NL + "        }        " + NL + "      }" + NL + "      " + NL + "      if (out_";
  protected final String TEXT_104 = " != null)  out_";
  protected final String TEXT_105 = ".close();" + NL + "      globalMap.put(\"";
  protected final String TEXT_106 = "_ARCHIVE_FILEPATH\",zipFile_";
  protected final String TEXT_107 = ");" + NL + "      globalMap.put(\"";
  protected final String TEXT_108 = "_ARCHIVE_FILENAME\",(";
  protected final String TEXT_109 = ").contains(\"\\\\\")?" + NL + "    (";
  protected final String TEXT_110 = ").substring(((";
  protected final String TEXT_111 = ").lastIndexOf(\"\\\\\")+2)): (";
  protected final String TEXT_112 = ").substring(((";
  protected final String TEXT_113 = ").lastIndexOf(\"/\"))+1));";
