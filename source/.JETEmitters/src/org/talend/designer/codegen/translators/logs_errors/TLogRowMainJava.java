...
public class TLogRowMainJava
{
  ...
  protected final String TEXT_74 = ");" + NL + "                    }" + NL + "                    " + NL + "                    consoleOut_";
  protected final String TEXT_75 = ".println(strBuffer_";
  protected final String TEXT_76 = ".toString());" + NL + "                    consoleOut_";
  protected final String TEXT_77 = ".flush();" + NL + "                    nb_line_";
  protected final String TEXT_78 = "++;";
  protected final String TEXT_79 = NL + "\t\t\t\t" + NL + "\t\t\t\tString[] row_";
  protected final String TEXT_80 = " = new String[";
  protected final String TEXT_81 = "];" + NL;
  protected final String TEXT_82 = NL + "\t\t\t\t\t\tlogRowUtil_";
  protected final String TEXT_83 = ".putTableVerticalValue_";
  protected final String TEXT_84 = "(";
  protected final String TEXT_85 = ",row_";
  protected final String TEXT_86 = ");";
  protected final String TEXT_87 = "   \t\t\t\t" + NL + "\t    \t\tif(";
  protected final String TEXT_88 = ".";
  protected final String TEXT_89 = " != null) { //";
  protected final String TEXT_90 = "              " + NL + "                 row_";
  protected final String TEXT_91 = "[";
  protected final String TEXT_92 = "]=    \t\t\t\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\t\t\t\t\t\tFormatterUtils.format_Date(";
  ...
  protected final String TEXT_101 = ".toPlainString()";
  protected final String TEXT_102 = NL + "\t\t\t\t\t\t\t\tFormatterUtils.formatUnwithE(";
  protected final String TEXT_103 = ".";
  protected final String TEXT_104 = ")";
  protected final String TEXT_105 = "    " + NL + "\t\t\t\t                String.valueOf(";
  protected final String TEXT_106 = ".";
  protected final String TEXT_107 = ")\t\t\t";
  protected final String TEXT_108 = NL + "\t\t\t\t\t          ;\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_109 = NL + "\t    \t\t} //";
  protected final String TEXT_110 = "\t\t\t" + NL + "    \t\t\t";
  protected final String TEXT_111 = " " + NL + "" + NL + "\t\t\t\tutil_";
  protected final String TEXT_112 = ".addRow(row_";
  protected final String TEXT_113 = ");\t" + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_114 = "++;";
  protected final String TEXT_115 = NL + "\t\t\t\tnb_line_";
  protected final String TEXT_116 = "++;" + NL + "                consoleOut_";
  protected final String TEXT_117 = ".println(util_";
  protected final String TEXT_118 = ".print(row_";
  protected final String TEXT_119 = ",nb_line_";
  protected final String TEXT_120 = "));" + NL + "                consoleOut_";
  protected final String TEXT_121 = ".flush();";
  protected final String TEXT_122 = NL + "//////" + NL + "" + NL + "//////                    " + NL + "                    " + NL + "///////////////////////    \t\t\t";
