...
public class TSOAPMainJava
{
  ...
  protected final String TEXT_2 = NL + "\tif(true)" + NL + "\t\tthrow new java.lang.Exception(\"There is no incoming connection or the incoming schema is empty\");";
  ...
  protected final String TEXT_15 = ");" + NL + "\t\t\t\t}catch(java.lang.Exception ex){" + NL + "\t\t\t\t\tex.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t\treturn null;" + NL + "\t\t\t}";
  ...
  protected final String TEXT_21 = ");" + NL + "\t\t\t\t}catch(java.lang.Exception ex){" + NL + "\t\t\t\t\tex.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t\treturn null;" + NL + "\t\t\t}";
