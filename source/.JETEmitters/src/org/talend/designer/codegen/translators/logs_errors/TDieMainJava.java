...
public class TDieMainJava
{
  ...
  protected final String TEXT_16 = "_DIE_MESSAGES\", ";
  protected final String TEXT_17 = ");" + NL + "\tcurrentComponent = \"";
  protected final String TEXT_18 = "\";" + NL + "\tstatus = \"failure\";";
  protected final String TEXT_19 = NL + "    \terrorCode = new Integer(";
  protected final String TEXT_20 = ");" + NL + "        ((java.util.Map)threadLocal.get()).put(\"errorCode\", new Integer(";
  protected final String TEXT_21 = "));" + NL + "        ((java.util.Map)threadLocal.get()).put(\"status\", \"failure\");" + NL + "        globalMap.put(\"";
  protected final String TEXT_22 = "_DIE_CODE\", errorCode);";
  protected final String TEXT_23 = NL + "        errorCode = new Integer(";
  protected final String TEXT_24 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_25 = "_DIE_CODE\", errorCode);        ";
  protected final String TEXT_26 = NL + "    ";
  protected final String TEXT_27 = NL + "\tSystem.exit(";
  protected final String TEXT_28 = ");";
  protected final String TEXT_29 = NL + "\tif(true){\t" + NL + "\t    throw new TDieException();" + NL + "\t}";
