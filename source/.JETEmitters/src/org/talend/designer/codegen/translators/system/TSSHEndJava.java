...
public class TSSHEndJava
{
  ...
  protected final String TEXT_10 = NL + "\t/* Close the connection */" + NL + "\t";
  ...
  protected final String TEXT_18 = "_EXIT_CODE\",sess_";
  protected final String TEXT_19 = ".getExitStatus());" + NL + "\t" + NL + "\t\t";
  protected final String TEXT_20 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_21 = " - Done.\");" + NL + "\t\t";
