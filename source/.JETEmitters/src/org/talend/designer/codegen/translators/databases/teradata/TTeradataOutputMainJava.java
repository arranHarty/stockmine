...
public class TTeradataOutputMainJava {
  ...
  protected final String TEXT_442 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_557 = NL + "    \t\t////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_561 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e_";
  ...
  protected final String TEXT_565 = " - \" + e_";
  protected final String TEXT_566 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_567 = NL + "                    throw(e_";
  protected final String TEXT_568 = ");";
  protected final String TEXT_569 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_570 = " - \" + e_";
  protected final String TEXT_571 = ".getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_589 = NL + "            }" + NL + "            ///////////////////////////    \t\t" + NL + "    \t\t";
  ...
  protected final String TEXT_617 = ".addBatch();" + NL + "\t    \t\tnb_line_";
  protected final String TEXT_618 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_619 = NL + "\t\t    \t\tbatchSizeCounter_";
  protected final String TEXT_620 = "++;" + NL + "\t    \t\t";
  protected final String TEXT_621 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_622 = NL + "    \t\t//////////////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_623 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_624 = " = updatedCount_";
  protected final String TEXT_625 = " + pstmt_";
  protected final String TEXT_626 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_627 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_628 = " = true;";
  protected final String TEXT_629 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_630 = " - \" + e_";
  protected final String TEXT_631 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_632 = NL + "                    throw(e_";
  protected final String TEXT_633 = ");";
  protected final String TEXT_634 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_635 = " - \" + e_";
  protected final String TEXT_636 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_637 = NL + "                        ";
  protected final String TEXT_638 = " = new ";
  protected final String TEXT_639 = "Struct();";
  ...
  protected final String TEXT_659 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_660 = " = pstmt_";
  protected final String TEXT_661 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_662 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_663 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_664 = " = rs_";
  protected final String TEXT_665 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_666 = " > 0) {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_693 = ".executeUpdate();" + NL + "    \t\t\t} catch(java.lang.Exception e_";
  protected final String TEXT_694 = ") {" + NL + "    \t\t\t    whetherReject_";
  protected final String TEXT_695 = " = true;" + NL + "    \t\t\t    ";
  ...
  protected final String TEXT_700 = NL + "    \t                throw(e_";
  protected final String TEXT_701 = ");" + NL + "    \t                ";
  protected final String TEXT_702 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_703 = " - \" + e_";
  protected final String TEXT_704 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_715 = " + 1;" + NL + "    \t                    ";
  protected final String TEXT_716 = ".errorMessage = e_";
  protected final String TEXT_717 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_718 = ";" + NL + "    \t                    ";
  protected final String TEXT_719 = NL + "    \t                    System.err.print(e_";
  protected final String TEXT_720 = ".getMessage());" + NL + "    \t                    ";
  protected final String TEXT_721 = NL + "    \t\t\t}" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_738 = ".executeUpdate();" + NL + "    \t\t\t} catch(java.lang.Exception e_";
  protected final String TEXT_739 = ") {" + NL + "    \t\t\t    whetherReject_";
  protected final String TEXT_740 = " = true;" + NL + "    \t\t\t    ";
  protected final String TEXT_741 = NL + "    \t                ";
  protected final String TEXT_742 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_743 = " - \" + e_";
  protected final String TEXT_744 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_745 = NL + "    \t                throw(e_";
  protected final String TEXT_746 = ");" + NL + "    \t                ";
  protected final String TEXT_747 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_748 = " - \" + e_";
  protected final String TEXT_749 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_760 = " + 1;" + NL + "    \t                    ";
  protected final String TEXT_761 = ".errorMessage = e_";
  protected final String TEXT_762 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_763 = ";" + NL + "    \t                    ";
  protected final String TEXT_764 = NL + "    \t                    System.err.print(e_";
  protected final String TEXT_765 = ".getMessage());" + NL + "    \t                    ";
  protected final String TEXT_766 = NL + "    \t\t\t}" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_767 = "++;" + NL + "    \t\t";
  protected final String TEXT_768 = NL + "    \t    int updateFlag_";
  protected final String TEXT_769 = "=0;" + NL + "    \t    ";
  protected final String TEXT_770 = NL + "                    ";
  protected final String TEXT_771 = NL + "                        query_";
  protected final String TEXT_772 = " = ";
  protected final String TEXT_773 = ";";
  protected final String TEXT_774 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_775 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_776 = ".";
  protected final String TEXT_777 = ", pstmtUpdate_";
  ...
  protected final String TEXT_793 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_794 = "=pstmtUpdate_";
  protected final String TEXT_795 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_796 = " = updatedCount_";
  protected final String TEXT_797 = " + updateFlag_";
  protected final String TEXT_798 = ";" + NL + "        \t} catch(java.lang.Exception e_";
  protected final String TEXT_799 = ") {" + NL + "        \t    whetherReject_";
  protected final String TEXT_800 = " = true;" + NL + "        \t    ";
  protected final String TEXT_801 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_802 = " - \" + e_";
  protected final String TEXT_803 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_804 = NL + "                    throw(e_";
  protected final String TEXT_805 = ");";
  protected final String TEXT_806 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_807 = " - \" + e_";
  protected final String TEXT_808 = ".getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_821 = ".errorMessage = e_";
  protected final String TEXT_822 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_823 = ";";
  protected final String TEXT_824 = NL + "                        System.err.print(e_";
  protected final String TEXT_825 = ".getMessage());";
  protected final String TEXT_826 = NL + "        \t}" + NL + "        \tif(updateFlag_";
  protected final String TEXT_827 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_828 = NL + "\t\t\t\tquery_";
  protected final String TEXT_829 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_830 = NL + "                        ";
  protected final String TEXT_831 = NL + "                            query_";
  protected final String TEXT_832 = " = ";
  protected final String TEXT_833 = ";";
  protected final String TEXT_834 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_835 = ".";
  protected final String TEXT_836 = ", pstmtInsert_";
  ...
  protected final String TEXT_843 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_844 = " = insertedCount_";
  protected final String TEXT_845 = " + pstmtInsert_";
  protected final String TEXT_846 = ".executeUpdate();" + NL + "        \t\t} catch(java.lang.Exception e_";
  protected final String TEXT_847 = ") {" + NL + "        \t\t    whetherReject_";
  protected final String TEXT_848 = " = true;" + NL + "        \t\t    ";
  protected final String TEXT_849 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_850 = " - \" + e_";
  protected final String TEXT_851 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_852 = NL + "                        throw(e_";
  protected final String TEXT_853 = ");";
  protected final String TEXT_854 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_855 = " - \" + e_";
  protected final String TEXT_856 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_869 = ".errorMessage = e_";
  protected final String TEXT_870 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_871 = ";";
  protected final String TEXT_872 = NL + "                            System.err.print(e_";
  protected final String TEXT_873 = ".getMessage());";
  protected final String TEXT_874 = NL + "        \t\t}" + NL + "        \t} " + NL + "        \tnb_line_";
  ...
  protected final String TEXT_894 = NL + "    \t\t//////////////////////////////" + NL + "            try {" + NL + "              deletedCount_";
  protected final String TEXT_895 = " = deletedCount_";
  protected final String TEXT_896 = " + pstmt_";
  protected final String TEXT_897 = ".executeUpdate();" + NL + "    \t\t} catch(java.lang.Exception e_";
  protected final String TEXT_898 = ") {" + NL + "    \t\t    whetherReject_";
  ...
  protected final String TEXT_925 = NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_926 = "++;" + NL + "    \t\t//////////////////////////////////////    \t\t" + NL + "    \t\t";
  protected final String TEXT_927 = NL + NL + "    \t";
  protected final String TEXT_928 = NL + "                log4jSb_";
  protected final String TEXT_929 = ".append(";
  protected final String TEXT_930 = ".";
  protected final String TEXT_931 = ");";
  protected final String TEXT_932 = NL + "                \tlog4jSb_";
  protected final String TEXT_933 = ".append(\"|\");";
  protected final String TEXT_934 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_935 = " - Writing the record \" + nb_line_";
  protected final String TEXT_936 = " + \" \" + log4jSb_";
  protected final String TEXT_937 = ");" + NL + "\t\t\tlog4jSb_";
  protected final String TEXT_938 = ".delete(0,log4jSb_";
  protected final String TEXT_939 = ".length());" + NL + "\t\t";
  protected final String TEXT_940 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_951 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_952 = " <= batchSizeCounter_";
  protected final String TEXT_953 = ") {                ";
  protected final String TEXT_954 = "                                                " + NL + "                try {" + NL + "                \t\tbatchSizeCounter_";
  protected final String TEXT_955 = " = 0; " + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_956 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_957 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_958 = " += pstmt_";
  protected final String TEXT_959 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_960 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_961 = " += pstmt_";
  protected final String TEXT_962 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_963 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_964 = " += pstmt_";
  protected final String TEXT_965 = ". getUpdateCount();" + NL + "            \t    \t";
  ...
  protected final String TEXT_971 = " != null) {" + NL + "\t\t\t\t\t\tSystem.out.println(e_";
  protected final String TEXT_972 = ".getMessage());" + NL + "\t\t\t\t\t\te2_";
  protected final String TEXT_973 = " = e2_";
  protected final String TEXT_974 = ".getNextException();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_975 = NL + "\t\t\tjava.sql.SQLException e3_";
  protected final String TEXT_976 = " = e_";
  protected final String TEXT_977 = ";" + NL + "                \tboolean isFailure = false;" + NL + "\t\t\twhile(e_";
  protected final String TEXT_978 = " != null){" + NL + "\t\t\t\tif(e_";
  protected final String TEXT_979 = ".getErrorCode() == -2801){" + NL + "\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_980 = ".getMessage());" + NL + "\t\t\t\t\te_";
  protected final String TEXT_981 = ".printStackTrace();" + NL + "\t\t\t\t\tSystem.out.println();" + NL + "\t\t\t\t}" + NL + "\t\t\t\telse if(e_";
  protected final String TEXT_982 = ".getErrorCode() == 1339){" + NL + "\t\t\t\t\tisFailure = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\telse{" + NL + "\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_983 = ".getMessage());" + NL + "\t\t\t\t\te_";
  protected final String TEXT_984 = ".printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t\te_";
  protected final String TEXT_985 = " = e_";
  protected final String TEXT_986 = ".getNextException();" + NL + "\t\t\t}" + NL + "\t\t\tif(isFailure && e_";
  protected final String TEXT_987 = " != null){" + NL + "\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_988 = ".getMessage());" + NL + "\t\t\t\te_";
  protected final String TEXT_989 = ".printStackTrace();" + NL + "\t\t\t}" + NL + "                \t";
  protected final String TEXT_990 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_991 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_992 = " - \" + e3_";
  ...
  protected final String TEXT_997 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_998 = " - \" + e3_";
  protected final String TEXT_999 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1000 = NL + "\t\t\t\tSystem.err.println(e3_";
  protected final String TEXT_1001 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_1002 = "  " + NL + "                }";
  protected final String TEXT_1003 = "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1004 = NL + "                commitCounter_";
  protected final String TEXT_1005 = "++;" + NL + "                " + NL + "                if(commitEvery_";
  protected final String TEXT_1006 = " <= commitCounter_";
  protected final String TEXT_1007 = ") {" + NL + "                " + NL + "                \t";
  protected final String TEXT_1008 = NL + "\t\t                try {" + NL + "\t\t                \tcommitCounter_";
  protected final String TEXT_1009 = " = 0;" + NL + "\t\t                \t";
  protected final String TEXT_1010 = NL + "\t\t                \tbatchSizeCounter_";
  protected final String TEXT_1011 = " = 0;  " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_1012 = NL + "    \t\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_1013 = " > 0 ) {" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_1014 = NL + "\t\t                \t\t    pstmt_";
  protected final String TEXT_1015 = ".executeBatch();" + NL + "\t\t            \t    \t";
  protected final String TEXT_1016 = NL + "\t\t            \t    \t\tinsertedCount_";
  protected final String TEXT_1017 = " += pstmt_";
  protected final String TEXT_1018 = ".getUpdateCount();" + NL + "\t\t            \t    \t";
  protected final String TEXT_1019 = "            \t    \t\t" + NL + "\t\t            \t    \t\tupdatedCount_";
  protected final String TEXT_1020 = " += pstmt_";
  protected final String TEXT_1021 = ".getUpdateCount();" + NL + "\t\t            \t    \t";
  protected final String TEXT_1022 = NL + "\t\t            \t    \t    deletedCount_";
  protected final String TEXT_1023 = " += pstmt_";
  protected final String TEXT_1024 = ".getUpdateCount();" + NL + "\t\t            \t    \t";
  ...
  protected final String TEXT_1029 = " - Starting to commit.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1030 = NL + "\t\t\t        \tconn_";
  protected final String TEXT_1031 = ".commit();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1032 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_1033 = " - Commit has succeeded.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1034 = "\t\t                \t" + NL + "\t\t                }catch(java.sql.SQLException e_";
  protected final String TEXT_1035 = "){" + NL + "                    \t\t";
  protected final String TEXT_1036 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_1037 = " - \" + e_";
  protected final String TEXT_1038 = ".getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_1039 = NL + "\t\t                \t";
  protected final String TEXT_1040 = NL + "\t\t\t\t\t\t\tjava.sql.SQLException e2_";
  protected final String TEXT_1041 = " = e_";
  protected final String TEXT_1042 = ";" + NL + "\t\t\t\t\t\t\twhile (e2_";
  protected final String TEXT_1043 = " != null) {" + NL + "\t\t\t\t\t\t\t\tSystem.out.println(e_";
  protected final String TEXT_1044 = ".getMessage());" + NL + "\t\t\t\t\t\t\t\te2_";
  protected final String TEXT_1045 = " = e2_";
  protected final String TEXT_1046 = ".getNextException();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_1047 = NL + "\t\t\t\t\tjava.sql.SQLException e3_";
  protected final String TEXT_1048 = " = e_";
  protected final String TEXT_1049 = ";" + NL + "\t\t                \tboolean isFailure = false;" + NL + "\t\t\t\t\twhile(e_";
  protected final String TEXT_1050 = " != null){" + NL + "\t\t\t\t\t\tif(e_";
  protected final String TEXT_1051 = ".getErrorCode() == -2801){" + NL + "\t\t\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_1052 = ".getMessage());" + NL + "\t\t\t\t\t\t\te_";
  protected final String TEXT_1053 = ".printStackTrace();" + NL + "\t\t\t\t\t\t\tSystem.out.println();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse if(e_";
  protected final String TEXT_1054 = ".getErrorCode() == 1339){" + NL + "\t\t\t\t\t\t\tisFailure = true;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse{" + NL + "\t\t\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_1055 = ".getMessage());" + NL + "\t\t\t\t\t\t\te_";
  protected final String TEXT_1056 = ".printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\te_";
  protected final String TEXT_1057 = " = e_";
  protected final String TEXT_1058 = ".getNextException();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tif(isFailure && e_";
  protected final String TEXT_1059 = " != null){" + NL + "\t\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  ...
  protected final String TEXT_1064 = " - \" + e3_";
  protected final String TEXT_1065 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1066 = NL + "\t\t\t\t\t\tthrow (e3_";
  protected final String TEXT_1067 = ");" + NL + "\t\t                \t";
  protected final String TEXT_1068 = NL + "                   \t\t";
  protected final String TEXT_1069 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_1070 = " - \" + e3_";
  protected final String TEXT_1071 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1072 = NL + "\t\t\t\t\t\tSystem.err.println(e3_";
  protected final String TEXT_1073 = ".getMessage());" + NL + "\t\t                \t";
