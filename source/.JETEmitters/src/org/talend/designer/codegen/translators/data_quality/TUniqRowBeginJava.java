...
public class TUniqRowBeginJava
{
  ...
  protected final String TEXT_44 = NL + "KeyStruct_";
  protected final String TEXT_45 = " finder_";
  protected final String TEXT_46 = " = new KeyStruct_";
  protected final String TEXT_47 = "();" + NL + "java.util.Set<KeyStruct_";
  protected final String TEXT_48 = "> keys";
  protected final String TEXT_49 = " = new java.util.HashSet<KeyStruct_";
  protected final String TEXT_50 = ">();";
  protected final String TEXT_51 = NL + "java.util.Set<KeyStruct_";
  protected final String TEXT_52 = "> keysForDuplicated";
  protected final String TEXT_53 = " = new java.util.HashSet<KeyStruct_";
