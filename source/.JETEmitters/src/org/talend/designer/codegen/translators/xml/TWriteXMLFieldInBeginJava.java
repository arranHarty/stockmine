...
public class TWriteXMLFieldInBeginJava
{
  ...
  protected final String TEXT_11 = "_FINISH\", \"true\");" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tThreadXMLField_";
  ...
  protected final String TEXT_21 = " = 0;" + NL + "\t\t\t\twhile(true) {" + NL + "\t\t\t\t\t\tif (!queue_";
  protected final String TEXT_22 = ".isEmpty()) {" + NL + "\t\t\t";
