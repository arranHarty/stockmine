...
public class TS3BucketDeleteBeginJava
{
  ...
  protected final String TEXT_40 = ".deleteBucket(";
  protected final String TEXT_41 = ");" + NL + "\t}catch(java.lang.Exception e_";
  ...
  protected final String TEXT_47 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_48 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_49 = ".shutdown();" + NL + "\t\t}";
