...
public class TSAPHanaOutputMainJava {
  ...
  protected final String TEXT_561 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_578 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_601 = NL + "                globalMap.put(\"";
  protected final String TEXT_602 = "_QUERY\", query_";
  protected final String TEXT_603 = ".toString().trim());";
  protected final String TEXT_604 = NL + "    \t\t";
  protected final String TEXT_605 = NL + "    \t\tpstmt_";
  protected final String TEXT_606 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_607 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_608 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_609 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_610 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_611 = NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_615 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_671 = ".executeUpdate(); " + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_688 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_689 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_690 = NL + "                        ";
  protected final String TEXT_691 = NL + "                            query_";
  protected final String TEXT_692 = " = ";
  protected final String TEXT_693 = ";";
  protected final String TEXT_694 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_695 = ".";
  protected final String TEXT_696 = ", pstmtInsert_";
  protected final String TEXT_697 = ", ";
  protected final String TEXT_698 = ", \"";
  protected final String TEXT_699 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_700 = NL + "                    globalMap.put(\"";
  protected final String TEXT_701 = "_QUERY\", query_";
  protected final String TEXT_702 = ".toString().trim());";
  protected final String TEXT_703 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_704 = " = insertedCount_";
  protected final String TEXT_705 = " + pstmtInsert_";
  ...
  protected final String TEXT_775 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_776 = " == 0) {" + NL + "            \t";
  protected final String TEXT_777 = NL + "\t\t\t\tquery_";
  protected final String TEXT_778 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_795 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_810 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_811 = ";";
  protected final String TEXT_812 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_813 = NL + "                }" + NL + "            } " + NL + "    " + NL + "            nb_line_";
  ...
  protected final String TEXT_872 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_873 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_874 = ": pstmt_";
  protected final String TEXT_875 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_876 = " += (countEach_";
  protected final String TEXT_877 = " < 0 ? 0 : countEach_";
  protected final String TEXT_878 = ");" + NL + "\t\t\t\t\t\t}                \t" + NL + "            \t    \t";
  protected final String TEXT_879 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_880 = " += countSum_";
  protected final String TEXT_881 = ";" + NL + "            \t    \t";
  protected final String TEXT_882 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_883 = " += countSum_";
  protected final String TEXT_884 = ";" + NL + "            \t    \t";
  protected final String TEXT_885 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_886 = " += countSum_";
  protected final String TEXT_887 = ";" + NL + "            \t    \t";
  protected final String TEXT_888 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_889 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  ...
  protected final String TEXT_913 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_914 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_915 = ": pstmt_";
  protected final String TEXT_916 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_917 = " += (countEach_";
  protected final String TEXT_918 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_923 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_924 = " += countSum_";
  protected final String TEXT_925 = ";" + NL + "            \t    \t";
  protected final String TEXT_926 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_927 = " += countSum_";
  protected final String TEXT_928 = ";" + NL + "            \t    \t";
  protected final String TEXT_929 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_930 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_931 = NL + "                \t\tint countSum_";
  protected final String TEXT_932 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_933 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_934 = " += (countEach_";
  protected final String TEXT_935 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_940 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_941 = " += countSum_";
  protected final String TEXT_942 = ";" + NL + "            \t    \t";
  protected final String TEXT_943 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_944 = " += countSum_";
  protected final String TEXT_945 = ";" + NL + "            \t    \t";
  protected final String TEXT_946 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_947 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_948 = NL + "                \tconn_";
  protected final String TEXT_949 = ".commit();                " + NL + "                \tcommitCounter_";
