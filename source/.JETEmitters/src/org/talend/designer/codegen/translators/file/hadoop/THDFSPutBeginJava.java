...
public class THDFSPutBeginJava
{
  ...
  protected final String TEXT_63 = " = 0;" + NL + "\t" + NL + "\tfs_";
  protected final String TEXT_64 = ".mkdirs(new org.apache.hadoop.fs.Path(";
  protected final String TEXT_65 = "));" + NL + "\tjava.util.List<String> msg_";
  protected final String TEXT_66 = " = new java.util.ArrayList<String>();" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_67 = " = new java.util.ArrayList<java.util.Map<String,String>>();\t" + NL + "\t";
  protected final String TEXT_68 = "    " + NL + "\t\tjava.util.Map<String,String> map_";
  protected final String TEXT_69 = "_";
  protected final String TEXT_70 = " = new java.util.HashMap<String,String>();" + NL + "\t\tmap_";
  ...
  protected final String TEXT_78 = "\t" + NL + "" + NL + "\tString localdir_";
  protected final String TEXT_79 = "  = ";
  protected final String TEXT_80 = ";\t" + NL + "\tfor (java.util.Map<String, String> map_";
